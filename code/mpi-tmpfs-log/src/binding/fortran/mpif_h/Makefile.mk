...
mpi_f77_sources += src/binding/fortran/mpif_h/attr_proxy.c \
	...
	src/binding/fortran/mpif_h/allgather_initf.c \
	src/binding/fortran/mpif_h/allgathervf.c \
	src/binding/fortran/mpif_h/allgatherv_initf.c \
	src/binding/fortran/mpif_h/allreducef.c \
	src/binding/fortran/mpif_h/allreduce_initf.c \
	src/binding/fortran/mpif_h/alltoallf.c \
	src/binding/fortran/mpif_h/alltoall_initf.c \
	src/binding/fortran/mpif_h/alltoallvf.c \
	src/binding/fortran/mpif_h/alltoallv_initf.c \
	src/binding/fortran/mpif_h/alltoallwf.c \
	src/binding/fortran/mpif_h/alltoallw_initf.c \
	src/binding/fortran/mpif_h/barrierf.c \
	src/binding/fortran/mpif_h/barrier_initf.c \
	src/binding/fortran/mpif_h/bcastf.c \
	src/binding/fortran/mpif_h/bcast_initf.c \
	src/binding/fortran/mpif_h/exscanf.c \
	src/binding/fortran/mpif_h/exscan_initf.c \
	src/binding/fortran/mpif_h/gatherf.c \
	src/binding/fortran/mpif_h/gather_initf.c \
	src/binding/fortran/mpif_h/gathervf.c \
	src/binding/fortran/mpif_h/gatherv_initf.c \
	...
	src/binding/fortran/mpif_h/neighbor_allgather_initf.c \
	src/binding/fortran/mpif_h/neighbor_allgathervf.c \
	src/binding/fortran/mpif_h/neighbor_allgatherv_initf.c \
	src/binding/fortran/mpif_h/neighbor_alltoallf.c \
	src/binding/fortran/mpif_h/neighbor_alltoall_initf.c \
	src/binding/fortran/mpif_h/neighbor_alltoallvf.c \
	src/binding/fortran/mpif_h/neighbor_alltoallv_initf.c \
	src/binding/fortran/mpif_h/neighbor_alltoallwf.c \
	src/binding/fortran/mpif_h/neighbor_alltoallw_initf.c \
	src/binding/fortran/mpif_h/reducef.c \
	src/binding/fortran/mpif_h/reduce_initf.c \
	...
	src/binding/fortran/mpif_h/reduce_scatter_block_initf.c \
	src/binding/fortran/mpif_h/reduce_scatter_initf.c \
	src/binding/fortran/mpif_h/scanf.c \
	src/binding/fortran/mpif_h/scan_initf.c \
	src/binding/fortran/mpif_h/scatterf.c \
	src/binding/fortran/mpif_h/scatter_initf.c \
	src/binding/fortran/mpif_h/scattervf.c \
	src/binding/fortran/mpif_h/scatterv_initf.c \
	...
	src/binding/fortran/mpif_h/comm_idup_with_infof.c \
	...
	src/binding/fortran/mpif_h/intercomm_create_from_groupsf.c \
	...
	src/binding/fortran/mpif_h/packf.c \
	...
	src/binding/fortran/mpif_h/unpackf.c \
	...
	src/binding/fortran/mpif_h/session_call_errhandlerf.c \
	src/binding/fortran/mpif_h/session_create_errhandlerf.c \
	src/binding/fortran/mpif_h/session_get_errhandlerf.c \
	src/binding/fortran/mpif_h/session_set_errhandlerf.c \
	...
	src/binding/fortran/mpif_h/delete_error_classf.c \
	src/binding/fortran/mpif_h/delete_error_codef.c \
	src/binding/fortran/mpif_h/delete_error_stringf.c \
	...
	src/binding/fortran/mpif_h/session_finalizef.c \
	src/binding/fortran/mpif_h/session_get_infof.c \
	src/binding/fortran/mpif_h/session_get_nth_psetf.c \
	src/binding/fortran/mpif_h/session_get_num_psetsf.c \
	src/binding/fortran/mpif_h/session_get_pset_infof.c \
	src/binding/fortran/mpif_h/session_initf.c \
	...
	src/binding/fortran/mpif_h/query_ze_supportf.c \
	src/binding/fortran/mpif_h/op_commutativef.c \
	src/binding/fortran/mpif_h/op_createf.c \
	src/binding/fortran/mpif_h/op_freef.c \
	src/binding/fortran/mpif_h/parrivedf.c \
	src/binding/fortran/mpif_h/preadyf.c \
	src/binding/fortran/mpif_h/pready_listf.c \
	src/binding/fortran/mpif_h/pready_rangef.c \
	src/binding/fortran/mpif_h/precv_initf.c \
	src/binding/fortran/mpif_h/psend_initf.c \
	src/binding/fortran/mpif_h/bsendf.c \
	...
	src/binding/fortran/mpif_h/irecvf.c \
	src/binding/fortran/mpif_h/irsendf.c \
	src/binding/fortran/mpif_h/isendf.c \
	src/binding/fortran/mpif_h/isendrecvf.c \
	src/binding/fortran/mpif_h/isendrecv_replacef.c \
	src/binding/fortran/mpif_h/issendf.c \
	src/binding/fortran/mpif_h/mprobef.c \
	src/binding/fortran/mpif_h/mrecvf.c src/binding/fortran/mpif_h/probef.c \
	...
	src/binding/fortran/mpif_h/waitf.c \
	...
	src/binding/fortran/mpif_h/getf.c \
	src/binding/fortran/mpif_h/get_accumulatef.c \
	src/binding/fortran/mpif_h/putf.c \
	src/binding/fortran/mpif_h/raccumulatef.c \
	src/binding/fortran/mpif_h/rgetf.c \
	src/binding/fortran/mpif_h/rget_accumulatef.c \
	src/binding/fortran/mpif_h/rputf.c \
	...
	src/binding/fortran/mpif_h/file_read_cf.c \
	src/binding/fortran/mpif_h/file_read_all_cf.c \
	src/binding/fortran/mpif_h/file_read_all_begin_cf.c \
	src/binding/fortran/mpif_h/file_read_at_cf.c \
	src/binding/fortran/mpif_h/file_read_at_all_cf.c \
	src/binding/fortran/mpif_h/file_read_at_all_begin_cf.c \
	src/binding/fortran/mpif_h/file_read_ordered_cf.c \
	src/binding/fortran/mpif_h/file_read_ordered_begin_cf.c \
	src/binding/fortran/mpif_h/file_read_shared_cf.c \
	src/binding/fortran/mpif_h/file_write_cf.c \
	src/binding/fortran/mpif_h/file_write_all_cf.c \
	src/binding/fortran/mpif_h/file_write_all_begin_cf.c \
	src/binding/fortran/mpif_h/file_write_at_cf.c \
	src/binding/fortran/mpif_h/file_write_at_all_cf.c \
	src/binding/fortran/mpif_h/file_write_at_all_begin_cf.c \
	src/binding/fortran/mpif_h/file_write_ordered_cf.c \
	src/binding/fortran/mpif_h/file_write_ordered_begin_cf.c \
	src/binding/fortran/mpif_h/file_write_shared_cf.c \
	src/binding/fortran/mpif_h/file_iread_cf.c \
	src/binding/fortran/mpif_h/file_iread_all_cf.c \
	src/binding/fortran/mpif_h/file_iread_at_cf.c \
	src/binding/fortran/mpif_h/file_iread_at_all_cf.c \
	src/binding/fortran/mpif_h/file_iread_shared_cf.c \
	src/binding/fortran/mpif_h/file_iwrite_cf.c \
	src/binding/fortran/mpif_h/file_iwrite_all_cf.c \
	src/binding/fortran/mpif_h/file_iwrite_at_cf.c \
	src/binding/fortran/mpif_h/file_iwrite_at_all_cf.c \
	src/binding/fortran/mpif_h/file_iwrite_shared_cf.c \
	src/binding/fortran/mpif_h/file_get_type_extent_cf.c \
	src/binding/fortran/mpif_h/register_datarep_cf.c \
	...
	src/binding/fortran/mpif_h/infocrenv.c 
