...
/*@
   MPI_Iexscan_c - Computes the exclusive scan (partial reductions) of data on a collection of processes in a nonblocking way

Input Parameters:
+ sendbuf - starting address of send buffer (choice) (choice)
. count - number of elements in input buffer (non-negative integer) (non-negative integer)
