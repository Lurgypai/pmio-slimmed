...
/*@
   MPI_Neighbor_allgather_init - Create a persistent request for neighbor_allgather.
...
/*@
   MPI_Neighbor_allgather_init_c - Create a persistent request for neighbor_allgather.
