...
/*@
   MPI_Iscatter_c - Sends data from one process to all other processes in a communicator in a nonblocking way

Input Parameters:
+ sendbuf - address of send buffer (choice) (choice)
. sendcount - number of elements sent to each process (non-negative integer) (non-negative integer)
