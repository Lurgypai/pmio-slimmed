...
/*@
   MPI_Reduce_scatter_c - Combines values and scatters the results

Input Parameters:
+ sendbuf - starting address of send buffer (choice) (choice)
. recvcounts - non-negative integer array (of length group size) specifying the number of elements of the result distributed to each process. (non-negative integer) (non-negative integer)
