...
/*@
   MPI_Gather_init - Create a persistent request for gather.
...
/*@
   MPI_Gather_init_c - Create a persistent request for gather.
...
. recvcount - number of elements for any single receive (non-negative integer) (non-negative integer)
