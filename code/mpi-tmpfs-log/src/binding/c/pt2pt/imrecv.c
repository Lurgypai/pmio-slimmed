...
/*@
   MPI_Imrecv_c - Nonblocking receive of message matched by MPI_Mprobe or MPI_Improbe.

Input Parameters:
+ count - number of elements in receive buffer (non-negative integer) (non-negative integer)
- datatype - datatype of each receive buffer element (handle) (handle)
