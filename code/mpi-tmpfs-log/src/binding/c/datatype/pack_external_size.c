...
/*@
   MPI_Pack_external_size_c - Returns the upper bound on the amount of space needed to pack a message using MPI_Pack_external.

Input Parameters:
+ datarep - data representation (string) (string)
. incount - number of input data items (integer) (integer)
- datatype - datatype of each input data item (handle) (handle)

Output Parameters:
. size - output buffer size, in bytes (integer) (integer)
