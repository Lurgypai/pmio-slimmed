...
. insize - input buffer size, in bytes (integer) (integer)
. outcount - number of output data items (integer) (integer)
- datatype - datatype of output data item (handle) (handle)
