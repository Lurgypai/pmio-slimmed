...
Input Parameters:
+ size - size of process group (positive integer) (positive integer)
. rank - rank in process group (non-negative integer) (non-negative integer)
. ndims - number of array dimensions as well as process grid dimensions (positive integer) (positive integer)
. array_of_gsizes - number of elements of type oldtype in each dimension of global array (positive integer) (positive integer)
. array_of_distribs - distribution of array in each dimension (state) (state)
. array_of_dargs - distribution argument in each dimension (positive integer) (positive integer)
. array_of_psizes - size of process grid in each dimension (positive integer) (positive integer)
. order - array storage order flag (state) (state)
