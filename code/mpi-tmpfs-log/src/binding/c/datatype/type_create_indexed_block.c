...
/*@
   MPI_Type_create_indexed_block_c - Create an indexed datatype with constant-sized blocks

Input Parameters:
+ count - length of array of displacements (non-negative integer) (non-negative integer)
. blocklength - size of block (non-negative integer) (non-negative integer)
. array_of_displacements - array of displacements (integer) (integer)
