...
/*@
   MPI_Type_create_subarray_c - Create a datatype for a subarray of a regular, multidimensional array

Input Parameters:
+ ndims - number of array dimensions (positive integer) (positive integer)
. array_of_sizes - number of elements of type oldtype in each dimension of the full array (positive integer) (positive integer)
. array_of_subsizes - number of elements of type oldtype in each dimension of the subarray (positive integer) (positive integer)
. array_of_starts - starting coordinates of the subarray in each dimension (non-negative integer) (non-negative integer)
