...
/*@
   MPI_Type_create_resized_c - Create a datatype with a new lower bound and extent from an existing datatype

Input Parameters:
+ oldtype - input datatype (handle) (handle)
. lb - new lower bound of datatype (integer) (integer)
- extent - new extent of datatype (integer) (integer)

Output Parameters:
. newtype - output datatype (handle) (handle)
