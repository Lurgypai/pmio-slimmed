...
. max_integers - number of elements in array_of_integers (non-negative integer) (non-negative integer)
. max_addresses - number of elements in array_of_addresses (non-negative integer) (non-negative integer)
. max_large_counts - number of elements in array_of_large_counts (non-negative integer)
- max_datatypes - number of elements in array_of_datatypes (non-negative integer) (non-negative integer)

Output Parameters:
+ array_of_integers - contains integer arguments used in constructing datatype (integer) (integer)
. array_of_addresses - contains address arguments used in constructing datatype (integer) (integer)
. array_of_large_counts - contains large count arguments used in constructing datatype (integer)
- array_of_datatypes - contains datatype arguments used in constructing datatype (handle) (handle)
