...
static const char short_gen218[] = "**invalid_netmod";
static const char long_gen218[]  = "Invalid netmod specified";
static const char short_gen219[] = "**invalid_refcount";
static const char long_gen219[]  = "invalid reference count";
static const char short_gen220[] = "**invalidmembind";
static const char long_gen220[]  = " Invalid bind object identifier.";
static const char short_gen221[] = "**invalidpkt";
static const char long_gen221[]  = " Invalid packet type";
static const char short_gen222[] = "**io";
static const char long_gen222[]  = "Other I/O error ";
static const char short_gen223[] = "**ioRMWrdwr";
static const char long_gen223[]  = "Must open file with MPI_MODE_RDWR for read-modify-write";
static const char short_gen224[] = "**ioagnomatch";
static const char long_gen224[]  = "No aggregators match";
static const char short_gen225[] = "**ioamodeseq";
static const char long_gen225[]  = "Cannot use this function when the file is opened with amode MPI_MODE_SEQUENTIAL ";
static const char short_gen226[] = "**iobadcount";
static const char long_gen226[]  = "Invalid count argument";
static const char short_gen227[] = "**iobaddisp";
static const char long_gen227[]  = "Invalid displacement argument";
static const char short_gen228[] = "**iobadfh";
static const char long_gen228[]  = "Invalid file handle";
static const char short_gen229[] = "**iobadoffset";
static const char long_gen229[]  = "Invalid offset argument";
static const char short_gen230[] = "**iobadoverlap";
static const char long_gen230[]  = " write voilates monotonically non-decreasing";
static const char short_gen231[] = "**iobadsize";
static const char long_gen231[]  = "Invalid size argument";
static const char short_gen232[] = "**iobadwhence";
static const char long_gen232[]  = "Invalid whence argument";
static const char short_gen233[] = "**iodatarepnomem";
static const char long_gen233[]  = "User must allocate memory for datarep";
static const char short_gen234[] = "**iodispifseq";
static const char long_gen234[]  = "disp must be set to MPI_DISPLACEMENT_CURRENT since file was opened with MPI_MODE_SEQUENTIAL";
static const char short_gen235[] = "**ioetype";
static const char long_gen235[]  = "Only an integral number of etypes can be accessed";
static const char short_gen236[] = "**iofiletype";
static const char long_gen236[]  = "Filetype must be constructed out of one or more etypes";
static const char short_gen237[] = "**iofstypeunsupported";
static const char long_gen237[]  = "Specified filesystem is not available";
static const char short_gen238[] = "**ioneedrd";
static const char long_gen238[]  = "Read access is required to this file";
static const char short_gen239[] = "**ionegoffset";
static const char long_gen239[]  = "Negative offset argument";
static const char short_gen240[] = "**iopreallocrdwr";
static const char long_gen240[]  = "Must open file with MPI_MODE_RDWR to preallocate disk space";
static const char short_gen241[] = "**iordonly";
static const char long_gen241[]  = "Cannot write to a file opened with amode MPI_MODE_RDONLY";
static const char short_gen242[] = "**iorsrc";
static const char long_gen242[]  = "Unable to read from the file as part of a strided read operation";
static const char short_gen243[] = "**iosequnsupported";
static const char long_gen243[]  = "MPI_MODE_SEQUENTIAL not supported on this file system";
static const char short_gen244[] = "**iosharedfailed";
static const char long_gen244[]  = "Could not access shared file pointer";
static const char short_gen245[] = "**iosharedunsupported";
static const char long_gen245[]  = "Shared file pointers not supported";
static const char short_gen246[] = "**iosplitcoll";
static const char long_gen246[]  = "Only one active split collective I/O operation is allowed per file handle";
static const char short_gen247[] = "**iosplitcollnone";
static const char long_gen247[]  = "No split collective I/O operation is active";
static const char short_gen248[] = "**iowronly";
static const char long_gen248[]  = "Cannot read from a file opened with amode MPI_MODE_WRONLY";
static const char short_gen249[] = "**iowsrc";
static const char long_gen249[]  = "Unable to read from the file as part of a strided write operation";
static const char short_gen250[] = "**iowswc";
static const char long_gen250[]  = "Unable to write to the file as part of a strided write operation";
static const char short_gen251[] = "**join_portname";
static const char long_gen251[]  = "local and remote port names are the same";
static const char short_gen252[] = "**join_recv";
static const char long_gen252[]  = "recv from the socket failed";
static const char short_gen253[] = "**join_send";
static const char long_gen253[]  = "send on the socket failed";
static const char short_gen254[] = "**keyval";
static const char long_gen254[]  = "Invalid keyval";
static const char short_gen255[] = "**keyvalinvalid";
static const char long_gen255[]  = "Attribute key was MPI_KEYVAL_INVALID";
static const char short_gen256[] = "**keyvalobj";
static const char long_gen256[]  = "Keyval was not defined for the supplied object";
static const char short_gen257[] = "**listen";
static const char long_gen257[]  = "listen failed";
static const char short_gen258[] = "**locktype";
static const char long_gen258[]  = "Invalid locktype argument";
static const char short_gen259[] = "**memcpyalias";
static const char long_gen259[]  = "memcpy arguments alias each other";
static const char short_gen260[] = "**mpi_abort";
static const char long_gen260[]  = "MPI_Abort failed";
static const char short_gen261[] = "**mpi_accumulate";
static const char long_gen261[]  = "MPI_Accumulate failed";
static const char short_gen262[] = "**mpi_accumulate_c";
static const char long_gen262[]  = "MPI_Accumulate_c failed";
static const char short_gen263[] = "**mpi_add_error_class";
static const char long_gen263[]  = "MPI_Add_error_class failed";
static const char short_gen264[] = "**mpi_add_error_code";
static const char long_gen264[]  = "MPI_Add_error_code failed";
static const char short_gen265[] = "**mpi_add_error_string";
static const char long_gen265[]  = "MPI_Add_error_string failed";
static const char short_gen266[] = "**mpi_allgather";
static const char long_gen266[]  = "MPI_Allgather failed";
static const char short_gen267[] = "**mpi_allgather_c";
static const char long_gen267[]  = "MPI_Allgather_c failed";
static const char short_gen268[] = "**mpi_allgather_init";
static const char long_gen268[]  = "MPI_Allgather_init failed";
static const char short_gen269[] = "**mpi_allgather_init_c";
static const char long_gen269[]  = "MPI_Allgather_init_c failed";
static const char short_gen270[] = "**mpi_allgatherv";
static const char long_gen270[]  = "MPI_Allgatherv failed";
static const char short_gen271[] = "**mpi_allgatherv_c";
static const char long_gen271[]  = "MPI_Allgatherv_c failed";
static const char short_gen272[] = "**mpi_allgatherv_init";
static const char long_gen272[]  = "MPI_Allgatherv_init failed";
static const char short_gen273[] = "**mpi_allgatherv_init_c";
static const char long_gen273[]  = "MPI_Allgatherv_init_c failed";
static const char short_gen274[] = "**mpi_alloc_mem";
static const char long_gen274[]  = "MPI_Alloc_mem failed";
static const char short_gen275[] = "**mpi_allreduce";
static const char long_gen275[]  = "MPI_Allreduce failed";
static const char short_gen276[] = "**mpi_allreduce_c";
static const char long_gen276[]  = "MPI_Allreduce_c failed";
static const char short_gen277[] = "**mpi_allreduce_init";
static const char long_gen277[]  = "MPI_Allreduce_init failed";
static const char short_gen278[] = "**mpi_allreduce_init_c";
static const char long_gen278[]  = "MPI_Allreduce_init_c failed";
static const char short_gen279[] = "**mpi_alltoall";
static const char long_gen279[]  = "MPI_Alltoall failed";
static const char short_gen280[] = "**mpi_alltoall_c";
static const char long_gen280[]  = "MPI_Alltoall_c failed";
static const char short_gen281[] = "**mpi_alltoall_init";
static const char long_gen281[]  = "MPI_Alltoall_init failed";
static const char short_gen282[] = "**mpi_alltoall_init_c";
static const char long_gen282[]  = "MPI_Alltoall_init_c failed";
static const char short_gen283[] = "**mpi_alltoallv";
static const char long_gen283[]  = "MPI_Alltoallv failed";
static const char short_gen284[] = "**mpi_alltoallv_c";
static const char long_gen284[]  = "MPI_Alltoallv_c failed";
static const char short_gen285[] = "**mpi_alltoallv_init";
static const char long_gen285[]  = "MPI_Alltoallv_init failed";
static const char short_gen286[] = "**mpi_alltoallv_init_c";
static const char long_gen286[]  = "MPI_Alltoallv_init_c failed";
static const char short_gen287[] = "**mpi_alltoallw";
static const char long_gen287[]  = "MPI_Alltoallw failed";
static const char short_gen288[] = "**mpi_alltoallw_c";
static const char long_gen288[]  = "MPI_Alltoallw_c failed";
static const char short_gen289[] = "**mpi_alltoallw_init";
static const char long_gen289[]  = "MPI_Alltoallw_init failed";
static const char short_gen290[] = "**mpi_alltoallw_init_c";
static const char long_gen290[]  = "MPI_Alltoallw_init_c failed";
static const char short_gen291[] = "**mpi_barrier";
static const char long_gen291[]  = "MPI_Barrier failed";
static const char short_gen292[] = "**mpi_barrier_init";
static const char long_gen292[]  = "MPI_Barrier_init failed";
static const char short_gen293[] = "**mpi_bcast";
static const char long_gen293[]  = "MPI_Bcast failed";
static const char short_gen294[] = "**mpi_bcast_c";
static const char long_gen294[]  = "MPI_Bcast_c failed";
static const char short_gen295[] = "**mpi_bcast_init";
static const char long_gen295[]  = "MPI_Bcast_init failed";
static const char short_gen296[] = "**mpi_bcast_init_c";
static const char long_gen296[]  = "MPI_Bcast_init_c failed";
static const char short_gen297[] = "**mpi_bsend";
static const char long_gen297[]  = "MPI_Bsend failed";
static const char short_gen298[] = "**mpi_bsend_c";
static const char long_gen298[]  = "MPI_Bsend_c failed";
static const char short_gen299[] = "**mpi_bsend_init";
static const char long_gen299[]  = "MPI_Bsend_init failed";
static const char short_gen300[] = "**mpi_bsend_init_c";
static const char long_gen300[]  = "MPI_Bsend_init_c failed";
static const char short_gen301[] = "**mpi_buffer_attach";
static const char long_gen301[]  = "MPI_Buffer_attach failed";
static const char short_gen302[] = "**mpi_buffer_attach_c";
static const char long_gen302[]  = "MPI_Buffer_attach_c failed";
static const char short_gen303[] = "**mpi_buffer_detach";
static const char long_gen303[]  = "MPI_Buffer_detach failed";
static const char short_gen304[] = "**mpi_buffer_detach_c";
static const char long_gen304[]  = "MPI_Buffer_detach_c failed";
static const char short_gen305[] = "**mpi_cancel";
static const char long_gen305[]  = "MPI_Cancel failed";
static const char short_gen306[] = "**mpi_cart_coords";
static const char long_gen306[]  = "MPI_Cart_coords failed";
static const char short_gen307[] = "**mpi_cart_create";
static const char long_gen307[]  = "MPI_Cart_create failed";
static const char short_gen308[] = "**mpi_cart_get";
static const char long_gen308[]  = "MPI_Cart_get failed";
static const char short_gen309[] = "**mpi_cart_map";
static const char long_gen309[]  = "MPI_Cart_map failed";
static const char short_gen310[] = "**mpi_cart_rank";
static const char long_gen310[]  = "MPI_Cart_rank failed";
static const char short_gen311[] = "**mpi_cart_shift";
static const char long_gen311[]  = "MPI_Cart_shift failed";
static const char short_gen312[] = "**mpi_cart_sub";
static const char long_gen312[]  = "MPI_Cart_sub failed";
static const char short_gen313[] = "**mpi_cartdim_get";
static const char long_gen313[]  = "MPI_Cartdim_get failed";
static const char short_gen314[] = "**mpi_close_port";
static const char long_gen314[]  = "MPI_Close_port failed";
static const char short_gen315[] = "**mpi_comm_accept";
static const char long_gen315[]  = "MPI_Comm_accept failed";
static const char short_gen316[] = "**mpi_comm_call_errhandler";
static const char long_gen316[]  = "MPI_Comm_call_errhandler failed";
static const char short_gen317[] = "**mpi_comm_compare";
static const char long_gen317[]  = "MPI_Comm_compare failed";
static const char short_gen318[] = "**mpi_comm_connect";
static const char long_gen318[]  = "MPI_Comm_connect failed";
static const char short_gen319[] = "**mpi_comm_create";
static const char long_gen319[]  = "MPI_Comm_create failed";
static const char short_gen320[] = "**mpi_comm_create_errhandler";
static const char long_gen320[]  = "MPI_Comm_create_errhandler failed";
static const char short_gen321[] = "**mpi_comm_create_from_group";
static const char long_gen321[]  = "MPI_Comm_create_from_group failed";
static const char short_gen322[] = "**mpi_comm_create_group";
static const char long_gen322[]  = "MPI_Comm_create_group failed";
static const char short_gen323[] = "**mpi_comm_create_keyval";
static const char long_gen323[]  = "MPI_Comm_create_keyval failed";
static const char short_gen324[] = "**mpi_comm_delete_attr";
static const char long_gen324[]  = "MPI_Comm_delete_attr failed";
static const char short_gen325[] = "**mpi_comm_disconnect";
static const char long_gen325[]  = "MPI_Comm_disconnect failed";
static const char short_gen326[] = "**mpi_comm_dup";
static const char long_gen326[]  = "MPI_Comm_dup failed";
static const char short_gen327[] = "**mpi_comm_dup_with_info";
static const char long_gen327[]  = "MPI_Comm_dup_with_info failed";
static const char short_gen328[] = "**mpi_comm_free";
static const char long_gen328[]  = "MPI_Comm_free failed";
static const char short_gen329[] = "**mpi_comm_free_keyval";
static const char long_gen329[]  = "MPI_Comm_free_keyval failed";
static const char short_gen330[] = "**mpi_comm_get_attr";
static const char long_gen330[]  = "MPI_Comm_get_attr failed";
static const char short_gen331[] = "**mpi_comm_get_errhandler";
static const char long_gen331[]  = "MPI_Comm_get_errhandler failed";
static const char short_gen332[] = "**mpi_comm_get_info";
static const char long_gen332[]  = "MPI_Comm_get_info failed";
static const char short_gen333[] = "**mpi_comm_get_name";
static const char long_gen333[]  = "MPI_Comm_get_name failed";
static const char short_gen334[] = "**mpi_comm_get_parent";
static const char long_gen334[]  = "MPI_Comm_get_parent failed";
static const char short_gen335[] = "**mpi_comm_group";
static const char long_gen335[]  = "MPI_Comm_group failed";
static const char short_gen336[] = "**mpi_comm_idup";
static const char long_gen336[]  = "MPI_Comm_idup failed";
static const char short_gen337[] = "**mpi_comm_idup_with_info";
static const char long_gen337[]  = "MPI_Comm_idup_with_info failed";
static const char short_gen338[] = "**mpi_comm_join";
static const char long_gen338[]  = "MPI_Comm_join failed";
static const char short_gen339[] = "**mpi_comm_rank";
static const char long_gen339[]  = "MPI_Comm_rank failed";
static const char short_gen340[] = "**mpi_comm_remote_group";
static const char long_gen340[]  = "MPI_Comm_remote_group failed";
static const char short_gen341[] = "**mpi_comm_remote_size";
static const char long_gen341[]  = "MPI_Comm_remote_size failed";
static const char short_gen342[] = "**mpi_comm_set_attr";
static const char long_gen342[]  = "MPI_Comm_set_attr failed";
static const char short_gen343[] = "**mpi_comm_set_errhandler";
static const char long_gen343[]  = "MPI_Comm_set_errhandler failed";
static const char short_gen344[] = "**mpi_comm_set_info";
static const char long_gen344[]  = "MPI_Comm_set_info failed";
static const char short_gen345[] = "**mpi_comm_set_name";
static const char long_gen345[]  = "MPI_Comm_set_name failed";
static const char short_gen346[] = "**mpi_comm_size";
static const char long_gen346[]  = "MPI_Comm_size failed";
static const char short_gen347[] = "**mpi_comm_spawn";
static const char long_gen347[]  = "MPI_Comm_spawn failed";
static const char short_gen348[] = "**mpi_comm_spawn_multiple";
static const char long_gen348[]  = "MPI_Comm_spawn_multiple failed";
static const char short_gen349[] = "**mpi_comm_split";
static const char long_gen349[]  = "MPI_Comm_split failed";
static const char short_gen350[] = "**mpi_comm_split_type";
static const char long_gen350[]  = "MPI_Comm_split_type failed";
static const char short_gen351[] = "**mpi_comm_test_inter";
static const char long_gen351[]  = "MPI_Comm_test_inter failed";
static const char short_gen352[] = "**mpi_compare_and_swap";
static const char long_gen352[]  = "MPI_Compare_and_swap failed";
static const char short_gen353[] = "**mpi_dims_create";
static const char long_gen353[]  = "MPI_Dims_create failed";
static const char short_gen354[] = "**mpi_dist_graph_create";
static const char long_gen354[]  = "MPI_Dist_graph_create failed";
static const char short_gen355[] = "**mpi_dist_graph_create_adjacent";
static const char long_gen355[]  = "MPI_Dist_graph_create_adjacent failed";
static const char short_gen356[] = "**mpi_dist_graph_neighbors";
static const char long_gen356[]  = "MPI_Dist_graph_neighbors failed";
static const char short_gen357[] = "**mpi_dist_graph_neighbors_count";
static const char long_gen357[]  = "MPI_Dist_graph_neighbors_count failed";
static const char short_gen358[] = "**mpi_errhandler_free";
static const char long_gen358[]  = "MPI_Errhandler_free failed";
static const char short_gen359[] = "**mpi_error_class";
static const char long_gen359[]  = "MPI_Error_class failed";
static const char short_gen360[] = "**mpi_error_string";
static const char long_gen360[]  = "MPI_Error_string failed";
static const char short_gen361[] = "**mpi_exscan";
static const char long_gen361[]  = "MPI_Exscan failed";
static const char short_gen362[] = "**mpi_exscan_c";
static const char long_gen362[]  = "MPI_Exscan_c failed";
static const char short_gen363[] = "**mpi_exscan_init";
static const char long_gen363[]  = "MPI_Exscan_init failed";
static const char short_gen364[] = "**mpi_exscan_init_c";
static const char long_gen364[]  = "MPI_Exscan_init_c failed";
static const char short_gen365[] = "**mpi_fetch_and_op";
static const char long_gen365[]  = "MPI_Fetch_and_op failed";
static const char short_gen366[] = "**mpi_file_call_errhandler";
static const char long_gen366[]  = "MPI_File_call_errhandler failed";
...
static const char short_gen374[] = "**mpi_gather_c";
static const char long_gen374[]  = "MPI_Gather_c failed";
static const char short_gen375[] = "**mpi_gather_init";
static const char long_gen375[]  = "MPI_Gather_init failed";
static const char short_gen376[] = "**mpi_gather_init_c";
static const char long_gen376[]  = "MPI_Gather_init_c failed";
static const char short_gen377[] = "**mpi_gatherv";
static const char long_gen377[]  = "MPI_Gatherv failed";
static const char short_gen378[] = "**mpi_gatherv_c";
static const char long_gen378[]  = "MPI_Gatherv_c failed";
static const char short_gen379[] = "**mpi_gatherv_init";
static const char long_gen379[]  = "MPI_Gatherv_init failed";
static const char short_gen380[] = "**mpi_gatherv_init_c";
static const char long_gen380[]  = "MPI_Gatherv_init_c failed";
static const char short_gen381[] = "**mpi_get";
static const char long_gen381[]  = "MPI_Get failed";
static const char short_gen382[] = "**mpi_get_accumulate";
static const char long_gen382[]  = "MPI_Get_accumulate failed";
static const char short_gen383[] = "**mpi_get_accumulate_c";
static const char long_gen383[]  = "MPI_Get_accumulate_c failed";
static const char short_gen384[] = "**mpi_get_address";
static const char long_gen384[]  = "MPI_Get_address failed";
static const char short_gen385[] = "**mpi_get_c";
static const char long_gen385[]  = "MPI_Get_c failed";
static const char short_gen386[] = "**mpi_get_count";
static const char long_gen386[]  = "MPI_Get_count failed";
static const char short_gen387[] = "**mpi_get_count_c";
static const char long_gen387[]  = "MPI_Get_count_c failed";
static const char short_gen388[] = "**mpi_get_elements";
static const char long_gen388[]  = "MPI_Get_elements failed";
static const char short_gen389[] = "**mpi_get_elements_c";
static const char long_gen389[]  = "MPI_Get_elements_c failed";
static const char short_gen390[] = "**mpi_get_elements_x";
static const char long_gen390[]  = "MPI_Get_elements_x failed";
static const char short_gen391[] = "**mpi_get_library_version";
static const char long_gen391[]  = "MPI_Get_library_version failed";
static const char short_gen392[] = "**mpi_get_processor_name";
static const char long_gen392[]  = "MPI_Get_processor_name failed";
static const char short_gen393[] = "**mpi_get_version";
static const char long_gen393[]  = "MPI_Get_version failed";
static const char short_gen394[] = "**mpi_graph_create";
static const char long_gen394[]  = "MPI_Graph_create failed";
static const char short_gen395[] = "**mpi_graph_get";
static const char long_gen395[]  = "MPI_Graph_get failed";
static const char short_gen396[] = "**mpi_graph_map";
static const char long_gen396[]  = "MPI_Graph_map failed";
static const char short_gen397[] = "**mpi_graph_neighbors";
static const char long_gen397[]  = "MPI_Graph_neighbors failed";
static const char short_gen398[] = "**mpi_graph_neighbors_count";
static const char long_gen398[]  = "MPI_Graph_neighbors_count failed";
static const char short_gen399[] = "**mpi_graphdims_get";
static const char long_gen399[]  = "MPI_Graphdims_get failed";
static const char short_gen400[] = "**mpi_grequest_complete";
static const char long_gen400[]  = "MPI_Grequest_complete failed";
static const char short_gen401[] = "**mpi_grequest_start";
static const char long_gen401[]  = "MPI_Grequest_start failed";
static const char short_gen402[] = "**mpi_group_compare";
static const char long_gen402[]  = "MPI_Group_compare failed";
static const char short_gen403[] = "**mpi_group_difference";
static const char long_gen403[]  = "MPI_Group_difference failed";
static const char short_gen404[] = "**mpi_group_excl";
static const char long_gen404[]  = "MPI_Group_excl failed";
static const char short_gen405[] = "**mpi_group_free";
static const char long_gen405[]  = "MPI_Group_free failed";
static const char short_gen406[] = "**mpi_group_from_session_pset";
static const char long_gen406[]  = "MPI_Group_from_session_pset failed";
...
static const char short_gen416[] = "**mpi_iallgather_c";
static const char long_gen416[]  = "MPI_Iallgather_c failed";
static const char short_gen417[] = "**mpi_iallgatherv";
static const char long_gen417[]  = "MPI_Iallgatherv failed";
static const char short_gen418[] = "**mpi_iallgatherv_c";
static const char long_gen418[]  = "MPI_Iallgatherv_c failed";
static const char short_gen419[] = "**mpi_iallreduce";
static const char long_gen419[]  = "MPI_Iallreduce failed";
static const char short_gen420[] = "**mpi_iallreduce_c";
static const char long_gen420[]  = "MPI_Iallreduce_c failed";
static const char short_gen421[] = "**mpi_ialltoall";
static const char long_gen421[]  = "MPI_Ialltoall failed";
static const char short_gen422[] = "**mpi_ialltoall_c";
static const char long_gen422[]  = "MPI_Ialltoall_c failed";
static const char short_gen423[] = "**mpi_ialltoallv";
static const char long_gen423[]  = "MPI_Ialltoallv failed";
static const char short_gen424[] = "**mpi_ialltoallv_c";
static const char long_gen424[]  = "MPI_Ialltoallv_c failed";
static const char short_gen425[] = "**mpi_ialltoallw";
static const char long_gen425[]  = "MPI_Ialltoallw failed";
static const char short_gen426[] = "**mpi_ialltoallw_c";
static const char long_gen426[]  = "MPI_Ialltoallw_c failed";
static const char short_gen427[] = "**mpi_ibarrier";
static const char long_gen427[]  = "MPI_Ibarrier failed";
static const char short_gen428[] = "**mpi_ibcast";
static const char long_gen428[]  = "MPI_Ibcast failed";
static const char short_gen429[] = "**mpi_ibcast_c";
static const char long_gen429[]  = "MPI_Ibcast_c failed";
static const char short_gen430[] = "**mpi_ibsend";
static const char long_gen430[]  = "MPI_Ibsend failed";
static const char short_gen431[] = "**mpi_ibsend_c";
static const char long_gen431[]  = "MPI_Ibsend_c failed";
static const char short_gen432[] = "**mpi_iexscan";
static const char long_gen432[]  = "MPI_Iexscan failed";
static const char short_gen433[] = "**mpi_iexscan_c";
static const char long_gen433[]  = "MPI_Iexscan_c failed";
static const char short_gen434[] = "**mpi_igather";
static const char long_gen434[]  = "MPI_Igather failed";
static const char short_gen435[] = "**mpi_igather_c";
static const char long_gen435[]  = "MPI_Igather_c failed";
static const char short_gen436[] = "**mpi_igatherv";
static const char long_gen436[]  = "MPI_Igatherv failed";
static const char short_gen437[] = "**mpi_igatherv_c";
static const char long_gen437[]  = "MPI_Igatherv_c failed";
static const char short_gen438[] = "**mpi_improbe";
static const char long_gen438[]  = "MPI_Improbe failed";
static const char short_gen439[] = "**mpi_imrecv";
static const char long_gen439[]  = "MPI_Imrecv failed";
static const char short_gen440[] = "**mpi_imrecv_c";
static const char long_gen440[]  = "MPI_Imrecv_c failed";
static const char short_gen441[] = "**mpi_ineighbor_allgather";
static const char long_gen441[]  = "MPI_Ineighbor_allgather failed";
static const char short_gen442[] = "**mpi_ineighbor_allgather_c";
static const char long_gen442[]  = "MPI_Ineighbor_allgather_c failed";
static const char short_gen443[] = "**mpi_ineighbor_allgatherv";
static const char long_gen443[]  = "MPI_Ineighbor_allgatherv failed";
static const char short_gen444[] = "**mpi_ineighbor_allgatherv_c";
static const char long_gen444[]  = "MPI_Ineighbor_allgatherv_c failed";
static const char short_gen445[] = "**mpi_ineighbor_alltoall";
static const char long_gen445[]  = "MPI_Ineighbor_alltoall failed";
static const char short_gen446[] = "**mpi_ineighbor_alltoall_c";
static const char long_gen446[]  = "MPI_Ineighbor_alltoall_c failed";
static const char short_gen447[] = "**mpi_ineighbor_alltoallv";
static const char long_gen447[]  = "MPI_Ineighbor_alltoallv failed";
static const char short_gen448[] = "**mpi_ineighbor_alltoallv_c";
static const char long_gen448[]  = "MPI_Ineighbor_alltoallv_c failed";
static const char short_gen449[] = "**mpi_ineighbor_alltoallw";
static const char long_gen449[]  = "MPI_Ineighbor_alltoallw failed";
static const char short_gen450[] = "**mpi_ineighbor_alltoallw_c";
static const char long_gen450[]  = "MPI_Ineighbor_alltoallw_c failed";
static const char short_gen451[] = "**mpi_info_create";
static const char long_gen451[]  = "MPI_Info_create failed";
static const char short_gen452[] = "**mpi_info_create_env";
static const char long_gen452[]  = "MPI_Info_create_env failed";
static const char short_gen453[] = "**mpi_info_delete";
static const char long_gen453[]  = "MPI_Info_delete failed";
static const char short_gen454[] = "**mpi_info_dup";
static const char long_gen454[]  = "MPI_Info_dup failed";
static const char short_gen455[] = "**mpi_info_free";
static const char long_gen455[]  = "MPI_Info_free failed";
static const char short_gen456[] = "**mpi_info_get";
static const char long_gen456[]  = "MPI_Info_get failed";
static const char short_gen457[] = "**mpi_info_get_nkeys";
static const char long_gen457[]  = "MPI_Info_get_nkeys failed";
static const char short_gen458[] = "**mpi_info_get_nthkey";
static const char long_gen458[]  = "MPI_Info_get_nthkey failed";
static const char short_gen459[] = "**mpi_info_get_string";
static const char long_gen459[]  = "MPI_Info_get_string failed";
static const char short_gen460[] = "**mpi_info_get_valuelen";
static const char long_gen460[]  = "MPI_Info_get_valuelen failed";
static const char short_gen461[] = "**mpi_info_set";
static const char long_gen461[]  = "MPI_Info_set failed";
static const char short_gen462[] = "**mpi_init";
static const char long_gen462[]  = "MPI_Init failed";
static const char short_gen463[] = "**mpi_init_thread";
static const char long_gen463[]  = "MPI_Init_thread failed";
static const char short_gen464[] = "**mpi_initialized";
static const char long_gen464[]  = "MPI_Initialized failed";
static const char short_gen465[] = "**mpi_intercomm_create";
static const char long_gen465[]  = "MPI_Intercomm_create failed";
static const char short_gen466[] = "**mpi_intercomm_create_from_groups";
static const char long_gen466[]  = "MPI_Intercomm_create_from_groups failed";
static const char short_gen467[] = "**mpi_intercomm_merge";
static const char long_gen467[]  = "MPI_Intercomm_merge failed";
static const char short_gen468[] = "**mpi_iprobe";
static const char long_gen468[]  = "MPI_Iprobe failed";
static const char short_gen469[] = "**mpi_irecv";
static const char long_gen469[]  = "MPI_Irecv failed";
static const char short_gen470[] = "**mpi_irecv_c";
static const char long_gen470[]  = "MPI_Irecv_c failed";
static const char short_gen471[] = "**mpi_ireduce";
static const char long_gen471[]  = "MPI_Ireduce failed";
static const char short_gen472[] = "**mpi_ireduce_c";
static const char long_gen472[]  = "MPI_Ireduce_c failed";
static const char short_gen473[] = "**mpi_ireduce_scatter";
static const char long_gen473[]  = "MPI_Ireduce_scatter failed";
static const char short_gen474[] = "**mpi_ireduce_scatter_block";
static const char long_gen474[]  = "MPI_Ireduce_scatter_block failed";
static const char short_gen475[] = "**mpi_ireduce_scatter_block_c";
static const char long_gen475[]  = "MPI_Ireduce_scatter_block_c failed";
static const char short_gen476[] = "**mpi_ireduce_scatter_c";
static const char long_gen476[]  = "MPI_Ireduce_scatter_c failed";
static const char short_gen477[] = "**mpi_irsend";
static const char long_gen477[]  = "MPI_Irsend failed";
static const char short_gen478[] = "**mpi_irsend_c";
static const char long_gen478[]  = "MPI_Irsend_c failed";
static const char short_gen479[] = "**mpi_is_thread_main";
static const char long_gen479[]  = "MPI_Is_thread_main failed";
static const char short_gen480[] = "**mpi_iscan";
static const char long_gen480[]  = "MPI_Iscan failed";
static const char short_gen481[] = "**mpi_iscan_c";
static const char long_gen481[]  = "MPI_Iscan_c failed";
static const char short_gen482[] = "**mpi_iscatter";
static const char long_gen482[]  = "MPI_Iscatter failed";
static const char short_gen483[] = "**mpi_iscatter_c";
static const char long_gen483[]  = "MPI_Iscatter_c failed";
static const char short_gen484[] = "**mpi_iscatterv";
static const char long_gen484[]  = "MPI_Iscatterv failed";
static const char short_gen485[] = "**mpi_iscatterv_c";
static const char long_gen485[]  = "MPI_Iscatterv_c failed";
static const char short_gen486[] = "**mpi_isend";
static const char long_gen486[]  = "MPI_Isend failed";
static const char short_gen487[] = "**mpi_isend_c";
static const char long_gen487[]  = "MPI_Isend_c failed";
static const char short_gen488[] = "**mpi_isendrecv";
static const char long_gen488[]  = "MPI_Isendrecv failed";
static const char short_gen489[] = "**mpi_isendrecv_c";
static const char long_gen489[]  = "MPI_Isendrecv_c failed";
static const char short_gen490[] = "**mpi_isendrecv_replace";
static const char long_gen490[]  = "MPI_Isendrecv_replace failed";
static const char short_gen491[] = "**mpi_isendrecv_replace_c";
static const char long_gen491[]  = "MPI_Isendrecv_replace_c failed";
static const char short_gen492[] = "**mpi_issend";
static const char long_gen492[]  = "MPI_Issend failed";
static const char short_gen493[] = "**mpi_issend_c";
static const char long_gen493[]  = "MPI_Issend_c failed";
static const char short_gen494[] = "**mpi_lookup_name";
static const char long_gen494[]  = "MPI_Lookup_name failed";
static const char short_gen495[] = "**mpi_mprobe";
static const char long_gen495[]  = "MPI_Mprobe failed";
static const char short_gen496[] = "**mpi_mrecv";
static const char long_gen496[]  = "MPI_Mrecv failed";
static const char short_gen497[] = "**mpi_mrecv_c";
static const char long_gen497[]  = "MPI_Mrecv_c failed";
static const char short_gen498[] = "**mpi_neighbor_allgather";
static const char long_gen498[]  = "MPI_Neighbor_allgather failed";
static const char short_gen499[] = "**mpi_neighbor_allgather_c";
static const char long_gen499[]  = "MPI_Neighbor_allgather_c failed";
static const char short_gen500[] = "**mpi_neighbor_allgather_init";
static const char long_gen500[]  = "MPI_Neighbor_allgather_init failed";
static const char short_gen501[] = "**mpi_neighbor_allgather_init_c";
static const char long_gen501[]  = "MPI_Neighbor_allgather_init_c failed";
static const char short_gen502[] = "**mpi_neighbor_allgatherv";
static const char long_gen502[]  = "MPI_Neighbor_allgatherv failed";
static const char short_gen503[] = "**mpi_neighbor_allgatherv_c";
static const char long_gen503[]  = "MPI_Neighbor_allgatherv_c failed";
static const char short_gen504[] = "**mpi_neighbor_allgatherv_init";
static const char long_gen504[]  = "MPI_Neighbor_allgatherv_init failed";
static const char short_gen505[] = "**mpi_neighbor_allgatherv_init_c";
static const char long_gen505[]  = "MPI_Neighbor_allgatherv_init_c failed";
static const char short_gen506[] = "**mpi_neighbor_alltoall";
static const char long_gen506[]  = "MPI_Neighbor_alltoall failed";
static const char short_gen507[] = "**mpi_neighbor_alltoall_c";
static const char long_gen507[]  = "MPI_Neighbor_alltoall_c failed";
static const char short_gen508[] = "**mpi_neighbor_alltoall_init";
static const char long_gen508[]  = "MPI_Neighbor_alltoall_init failed";
static const char short_gen509[] = "**mpi_neighbor_alltoall_init_c";
static const char long_gen509[]  = "MPI_Neighbor_alltoall_init_c failed";
static const char short_gen510[] = "**mpi_neighbor_alltoallv";
static const char long_gen510[]  = "MPI_Neighbor_alltoallv failed";
static const char short_gen511[] = "**mpi_neighbor_alltoallv_c";
static const char long_gen511[]  = "MPI_Neighbor_alltoallv_c failed";
static const char short_gen512[] = "**mpi_neighbor_alltoallv_init";
static const char long_gen512[]  = "MPI_Neighbor_alltoallv_init failed";
static const char short_gen513[] = "**mpi_neighbor_alltoallv_init_c";
static const char long_gen513[]  = "MPI_Neighbor_alltoallv_init_c failed";
static const char short_gen514[] = "**mpi_neighbor_alltoallw";
static const char long_gen514[]  = "MPI_Neighbor_alltoallw failed";
static const char short_gen515[] = "**mpi_neighbor_alltoallw_c";
static const char long_gen515[]  = "MPI_Neighbor_alltoallw_c failed";
static const char short_gen516[] = "**mpi_neighbor_alltoallw_init";
static const char long_gen516[]  = "MPI_Neighbor_alltoallw_init failed";
static const char short_gen517[] = "**mpi_neighbor_alltoallw_init_c";
static const char long_gen517[]  = "MPI_Neighbor_alltoallw_init_c failed";
static const char short_gen518[] = "**mpi_op_commutative";
static const char long_gen518[]  = "MPI_Op_commutative failed";
static const char short_gen519[] = "**mpi_op_create";
static const char long_gen519[]  = "MPI_Op_create failed";
static const char short_gen520[] = "**mpi_op_create_c";
static const char long_gen520[]  = "MPI_Op_create_c failed";
static const char short_gen521[] = "**mpi_op_free";
static const char long_gen521[]  = "MPI_Op_free failed";
static const char short_gen522[] = "**mpi_open_port";
static const char long_gen522[]  = "MPI_Open_port failed";
static const char short_gen523[] = "**mpi_pack";
static const char long_gen523[]  = "MPI_Pack failed";
static const char short_gen524[] = "**mpi_pack_c";
static const char long_gen524[]  = "MPI_Pack_c failed";
static const char short_gen525[] = "**mpi_pack_external";
static const char long_gen525[]  = "MPI_Pack_external failed";
static const char short_gen526[] = "**mpi_pack_external_c";
static const char long_gen526[]  = "MPI_Pack_external_c failed";
static const char short_gen527[] = "**mpi_pack_external_size";
static const char long_gen527[]  = "MPI_Pack_external_size failed";
static const char short_gen528[] = "**mpi_pack_external_size_c";
static const char long_gen528[]  = "MPI_Pack_external_size_c failed";
static const char short_gen529[] = "**mpi_pack_size";
static const char long_gen529[]  = "MPI_Pack_size failed";
static const char short_gen530[] = "**mpi_pack_size_c";
static const char long_gen530[]  = "MPI_Pack_size_c failed";
static const char short_gen531[] = "**mpi_parrived";
static const char long_gen531[]  = "MPI_Parrived failed";
static const char short_gen532[] = "**mpi_pready";
static const char long_gen532[]  = "MPI_Pready failed";
static const char short_gen533[] = "**mpi_pready_list";
static const char long_gen533[]  = "MPI_Pready_list failed";
static const char short_gen534[] = "**mpi_pready_range";
static const char long_gen534[]  = "MPI_Pready_range failed";
static const char short_gen535[] = "**mpi_precv_init";
static const char long_gen535[]  = "MPI_Precv_init failed";
static const char short_gen536[] = "**mpi_probe";
static const char long_gen536[]  = "MPI_Probe failed";
static const char short_gen537[] = "**mpi_psend_init";
static const char long_gen537[]  = "MPI_Psend_init failed";
static const char short_gen538[] = "**mpi_publish_name";
static const char long_gen538[]  = "MPI_Publish_name failed";
static const char short_gen539[] = "**mpi_put";
static const char long_gen539[]  = "MPI_Put failed";
static const char short_gen540[] = "**mpi_put_c";
static const char long_gen540[]  = "MPI_Put_c failed";
static const char short_gen541[] = "**mpi_query_thread";
static const char long_gen541[]  = "MPI_Query_thread failed";
static const char short_gen542[] = "**mpi_raccumulate";
static const char long_gen542[]  = "MPI_Raccumulate failed";
static const char short_gen543[] = "**mpi_raccumulate_c";
static const char long_gen543[]  = "MPI_Raccumulate_c failed";
static const char short_gen544[] = "**mpi_recv";
static const char long_gen544[]  = "MPI_Recv failed";
static const char short_gen545[] = "**mpi_recv_c";
static const char long_gen545[]  = "MPI_Recv_c failed";
static const char short_gen546[] = "**mpi_recv_init";
static const char long_gen546[]  = "MPI_Recv_init failed";
static const char short_gen547[] = "**mpi_recv_init_c";
static const char long_gen547[]  = "MPI_Recv_init_c failed";
static const char short_gen548[] = "**mpi_reduce";
static const char long_gen548[]  = "MPI_Reduce failed";
static const char short_gen549[] = "**mpi_reduce_c";
static const char long_gen549[]  = "MPI_Reduce_c failed";
static const char short_gen550[] = "**mpi_reduce_init";
static const char long_gen550[]  = "MPI_Reduce_init failed";
static const char short_gen551[] = "**mpi_reduce_init_c";
static const char long_gen551[]  = "MPI_Reduce_init_c failed";
static const char short_gen552[] = "**mpi_reduce_local";
static const char long_gen552[]  = "MPI_Reduce_local failed";
static const char short_gen553[] = "**mpi_reduce_local_c";
static const char long_gen553[]  = "MPI_Reduce_local_c failed";
static const char short_gen554[] = "**mpi_reduce_scatter";
static const char long_gen554[]  = "MPI_Reduce_scatter failed";
static const char short_gen555[] = "**mpi_reduce_scatter_block";
static const char long_gen555[]  = "MPI_Reduce_scatter_block failed";
static const char short_gen556[] = "**mpi_reduce_scatter_block_c";
static const char long_gen556[]  = "MPI_Reduce_scatter_block_c failed";
static const char short_gen557[] = "**mpi_reduce_scatter_block_init";
static const char long_gen557[]  = "MPI_Reduce_scatter_block_init failed";
static const char short_gen558[] = "**mpi_reduce_scatter_block_init_c";
static const char long_gen558[]  = "MPI_Reduce_scatter_block_init_c failed";
static const char short_gen559[] = "**mpi_reduce_scatter_c";
static const char long_gen559[]  = "MPI_Reduce_scatter_c failed";
static const char short_gen560[] = "**mpi_reduce_scatter_init";
static const char long_gen560[]  = "MPI_Reduce_scatter_init failed";
static const char short_gen561[] = "**mpi_reduce_scatter_init_c";
static const char long_gen561[]  = "MPI_Reduce_scatter_init_c failed";
static const char short_gen562[] = "**mpi_request_free";
static const char long_gen562[]  = "MPI_Request_free failed";
static const char short_gen563[] = "**mpi_request_get_status";
static const char long_gen563[]  = "MPI_Request_get_status failed";
static const char short_gen564[] = "**mpi_rget";
static const char long_gen564[]  = "MPI_Rget failed";
static const char short_gen565[] = "**mpi_rget_accumulate";
static const char long_gen565[]  = "MPI_Rget_accumulate failed";
static const char short_gen566[] = "**mpi_rget_accumulate_c";
static const char long_gen566[]  = "MPI_Rget_accumulate_c failed";
static const char short_gen567[] = "**mpi_rget_c";
static const char long_gen567[]  = "MPI_Rget_c failed";
static const char short_gen568[] = "**mpi_rput";
static const char long_gen568[]  = "MPI_Rput failed";
static const char short_gen569[] = "**mpi_rput_c";
static const char long_gen569[]  = "MPI_Rput_c failed";
static const char short_gen570[] = "**mpi_rsend";
static const char long_gen570[]  = "MPI_Rsend failed";
static const char short_gen571[] = "**mpi_rsend_c";
static const char long_gen571[]  = "MPI_Rsend_c failed";
static const char short_gen572[] = "**mpi_rsend_init";
static const char long_gen572[]  = "MPI_Rsend_init failed";
static const char short_gen573[] = "**mpi_rsend_init_c";
static const char long_gen573[]  = "MPI_Rsend_init_c failed";
static const char short_gen574[] = "**mpi_scan";
static const char long_gen574[]  = "MPI_Scan failed";
static const char short_gen575[] = "**mpi_scan_c";
static const char long_gen575[]  = "MPI_Scan_c failed";
static const char short_gen576[] = "**mpi_scan_init";
static const char long_gen576[]  = "MPI_Scan_init failed";
static const char short_gen577[] = "**mpi_scan_init_c";
static const char long_gen577[]  = "MPI_Scan_init_c failed";
static const char short_gen578[] = "**mpi_scatter";
static const char long_gen578[]  = "MPI_Scatter failed";
static const char short_gen579[] = "**mpi_scatter_c";
static const char long_gen579[]  = "MPI_Scatter_c failed";
static const char short_gen580[] = "**mpi_scatter_init";
static const char long_gen580[]  = "MPI_Scatter_init failed";
static const char short_gen581[] = "**mpi_scatter_init_c";
static const char long_gen581[]  = "MPI_Scatter_init_c failed";
static const char short_gen582[] = "**mpi_scatterv";
static const char long_gen582[]  = "MPI_Scatterv failed";
static const char short_gen583[] = "**mpi_scatterv_c";
static const char long_gen583[]  = "MPI_Scatterv_c failed";
static const char short_gen584[] = "**mpi_scatterv_init";
static const char long_gen584[]  = "MPI_Scatterv_init failed";
static const char short_gen585[] = "**mpi_scatterv_init_c";
static const char long_gen585[]  = "MPI_Scatterv_init_c failed";
static const char short_gen586[] = "**mpi_send";
static const char long_gen586[]  = "MPI_Send failed";
static const char short_gen587[] = "**mpi_send_c";
static const char long_gen587[]  = "MPI_Send_c failed";
static const char short_gen588[] = "**mpi_send_init";
static const char long_gen588[]  = "MPI_Send_init failed";
static const char short_gen589[] = "**mpi_send_init_c";
static const char long_gen589[]  = "MPI_Send_init_c failed";
static const char short_gen590[] = "**mpi_sendrecv";
static const char long_gen590[]  = "MPI_Sendrecv failed";
static const char short_gen591[] = "**mpi_sendrecv_c";
static const char long_gen591[]  = "MPI_Sendrecv_c failed";
static const char short_gen592[] = "**mpi_sendrecv_replace";
static const char long_gen592[]  = "MPI_Sendrecv_replace failed";
static const char short_gen593[] = "**mpi_sendrecv_replace_c";
static const char long_gen593[]  = "MPI_Sendrecv_replace_c failed";
static const char short_gen594[] = "**mpi_session_call_errhandler";
static const char long_gen594[]  = "MPI_Session_call_errhandler failed";
static const char short_gen595[] = "**mpi_session_create_errhandler";
static const char long_gen595[]  = "MPI_Session_create_errhandler failed";
static const char short_gen596[] = "**mpi_session_finalize";
static const char long_gen596[]  = "MPI_Session_finalize failed";
static const char short_gen597[] = "**mpi_session_get_errhandler";
static const char long_gen597[]  = "MPI_Session_get_errhandler failed";
static const char short_gen598[] = "**mpi_session_get_info";
static const char long_gen598[]  = "MPI_Session_get_info failed";
static const char short_gen599[] = "**mpi_session_get_nth_pset";
static const char long_gen599[]  = "MPI_Session_get_nth_pset failed";
static const char short_gen600[] = "**mpi_session_get_num_psets";
static const char long_gen600[]  = "MPI_Session_get_num_psets failed";
static const char short_gen601[] = "**mpi_session_get_pset_info";
static const char long_gen601[]  = "MPI_Session_get_pset_info failed";
static const char short_gen602[] = "**mpi_session_init";
static const char long_gen602[]  = "MPI_Session_init failed";
static const char short_gen603[] = "**mpi_session_set_errhandler";
static const char long_gen603[]  = "MPI_Session_set_errhandler failed";
static const char short_gen604[] = "**mpi_ssend";
static const char long_gen604[]  = "MPI_Ssend failed";
static const char short_gen605[] = "**mpi_ssend_c";
static const char long_gen605[]  = "MPI_Ssend_c failed";
static const char short_gen606[] = "**mpi_ssend_init";
static const char long_gen606[]  = "MPI_Ssend_init failed";
static const char short_gen607[] = "**mpi_ssend_init_c";
static const char long_gen607[]  = "MPI_Ssend_init_c failed";
static const char short_gen608[] = "**mpi_start";
static const char long_gen608[]  = "MPI_Start failed";
static const char short_gen609[] = "**mpi_startall";
static const char long_gen609[]  = "MPI_Startall failed";
static const char short_gen610[] = "**mpi_status_set_cancelled";
static const char long_gen610[]  = "MPI_Status_set_cancelled failed";
static const char short_gen611[] = "**mpi_status_set_elements";
static const char long_gen611[]  = "MPI_Status_set_elements failed";
...
static const char short_spc441[] = "**mpi_status_set_elements_x %p %D %c";
static const char long_spc441[]  = "MPI_Status_set_elements_x(status=%p, %D, count=%c) failed";
static const char short_spc442[] = "**mpi_test %p %p %p";
static const char long_spc442[]  = "MPI_Test(request=%p, flag=%p, status=%p) failed";
static const char short_spc443[] = "**mpi_test_cancelled %p %p";
static const char long_spc443[]  = "MPI_Test_cancelled(status=%p, flag=%p) failed";
static const char short_spc444[] = "**mpi_testall %d %p %p %p";
static const char long_spc444[]  = "MPI_Testall(count=%d, array_of_requests=%p, flag=%p, array_of_statuses=%p) failed";
static const char short_spc445[] = "**mpi_testany %d %p %p %p %p";
static const char long_spc445[]  = "MPI_Testany(count=%d, array_of_requests=%p, indx=%p, flag=%p, status=%p) failed";
static const char short_spc446[] = "**mpi_testsome %d %p %p %p %p";
static const char long_spc446[]  = "MPI_Testsome(incount=%d, array_of_requests=%p, outcount=%p, array_of_indices=%p, array_of_statuses=%p) failed";
static const char short_spc447[] = "**mpi_topo_test %C %p";
static const char long_spc447[]  = "MPI_Topo_test(%C, status=%p) failed";
static const char short_spc448[] = "**mpi_type_commit %p";
static const char long_spc448[]  = "MPI_Type_commit(datatype=%p) failed";
static const char short_spc449[] = "**mpi_type_contiguous %d %D %p";
static const char long_spc449[]  = "MPI_Type_contiguous(count=%d, %D, newtype=%p) failed";
static const char short_spc450[] = "**mpi_type_contiguous_c %c %D %p";
static const char long_spc450[]  = "MPI_Type_contiguous_c(count=%c, %D, newtype=%p) failed";
static const char short_spc451[] = "**mpi_type_create_darray %d %d %d %p %p %p %p %d %D %p";
static const char long_spc451[]  = "MPI_Type_create_darray(size=%d, rank=%d, ndims=%d, array_of_gsizes=%p, array_of_distribs=%p, array_of_dargs=%p, array_of_psizes=%p, order=%d, %D, newtype=%p) failed";
static const char short_spc452[] = "**mpi_type_create_darray_c %d %d %d %p %p %p %p %d %D %p";
static const char long_spc452[]  = "MPI_Type_create_darray_c(size=%d, rank=%d, ndims=%d, array_of_gsizes=%p, array_of_distribs=%p, array_of_dargs=%p, array_of_psizes=%p, order=%d, %D, newtype=%p) failed";
static const char short_spc453[] = "**mpi_type_create_f90_complex %d %d";
static const char long_spc453[]  = "MPI_Type_create_f90_complex (precision=%d, range=%d) failed";
static const char short_spc454[] = "**mpi_type_create_f90_int %d";
static const char long_spc454[]  = " MPI_Type_create_f90_int (range=%d) failed";
static const char short_spc455[] = "**mpi_type_create_f90_real %d %d";
static const char long_spc455[]  = "MPI_Type_create_f90_real (precision=%d, range=%d) failed";
static const char short_spc456[] = "**mpi_type_create_hindexed %d %p %p %D %p";
static const char long_spc456[]  = "MPI_Type_create_hindexed(count=%d, array_of_blocklengths=%p, array_of_displacements=%p, %D, newtype=%p) failed";
static const char short_spc457[] = "**mpi_type_create_hindexed_block %d %d %p %D %p";
static const char long_spc457[]  = "MPI_Type_create_hindexed_block(count=%d, blocklength=%d, array_of_displacements=%p, %D, newtype=%p) failed";
static const char short_spc458[] = "**mpi_type_create_hindexed_block_c %c %c %p %D %p";
static const char long_spc458[]  = "MPI_Type_create_hindexed_block_c(count=%c, blocklength=%c, array_of_displacements=%p, %D, newtype=%p) failed";
static const char short_spc459[] = "**mpi_type_create_hindexed_c %c %p %p %D %p";
static const char long_spc459[]  = "MPI_Type_create_hindexed_c(count=%c, array_of_blocklengths=%p, array_of_displacements=%p, %D, newtype=%p) failed";
static const char short_spc460[] = "**mpi_type_create_hvector %d %d %L %D %p";
static const char long_spc460[]  = "MPI_Type_create_hvector(count=%d, blocklength=%d, stride=%L, %D, newtype=%p) failed";
static const char short_spc461[] = "**mpi_type_create_hvector_c %c %c %c %D %p";
static const char long_spc461[]  = "MPI_Type_create_hvector_c(count=%c, blocklength=%c, stride=%c, %D, newtype=%p) failed";
static const char short_spc462[] = "**mpi_type_create_indexed_block %d %d %p %D %p";
static const char long_spc462[]  = "MPI_Type_create_indexed_block(count=%d, blocklength=%d, array_of_displacements=%p, %D, newtype=%p) failed";
static const char short_spc463[] = "**mpi_type_create_indexed_block_c %c %c %p %D %p";
static const char long_spc463[]  = "MPI_Type_create_indexed_block_c(count=%c, blocklength=%c, array_of_displacements=%p, %D, newtype=%p) failed";
static const char short_spc464[] = "**mpi_type_create_keyval %p %p %p %p";
static const char long_spc464[]  = "MPI_Type_create_keyval(type_copy_attr_fn=%p, type_delete_attr_fn=%p, type_keyval=%p, extra_state=%p) failed";
static const char short_spc465[] = "**mpi_type_create_resized %D %L %L %p";
static const char long_spc465[]  = "MPI_Type_create_resized(%D, lb=%L, extent=%L, newtype=%p) failed";
static const char short_spc466[] = "**mpi_type_create_resized_c %D %c %c %p";
static const char long_spc466[]  = "MPI_Type_create_resized_c(%D, lb=%c, extent=%c, newtype=%p) failed";
static const char short_spc467[] = "**mpi_type_create_struct %d %p %p %p %p";
static const char long_spc467[]  = "MPI_Type_create_struct(count=%d, array_of_blocklengths=%p, array_of_displacements=%p, array_of_types=%p, newtype=%p) failed";
static const char short_spc468[] = "**mpi_type_create_struct_c %c %p %p %p %p";
static const char long_spc468[]  = "MPI_Type_create_struct_c(count=%c, array_of_blocklengths=%p, array_of_displacements=%p, array_of_types=%p, newtype=%p) failed";
static const char short_spc469[] = "**mpi_type_create_subarray %d %p %p %p %d %D %p";
static const char long_spc469[]  = "MPI_Type_create_subarray(ndims=%d, array_of_sizes=%p, array_of_subsizes=%p, array_of_starts=%p, order=%d, %D, newtype=%p) failed";
static const char short_spc470[] = "**mpi_type_create_subarray_c %d %p %p %p %d %D %p";
static const char long_spc470[]  = "MPI_Type_create_subarray_c(ndims=%d, array_of_sizes=%p, array_of_subsizes=%p, array_of_starts=%p, order=%d, %D, newtype=%p) failed";
static const char short_spc471[] = "**mpi_type_delete_attr %D %K";
static const char long_spc471[]  = "MPI_Type_delete_attr(%D, %K) failed";
static const char short_spc472[] = "**mpi_type_dup %D %p";
static const char long_spc472[]  = "MPI_Type_dup(%D, newtype=%p) failed";
static const char short_spc473[] = "**mpi_type_extent %D %p";
static const char long_spc473[]  = "MPI_Type_extent(%D, extent=%p) failed";
static const char short_spc474[] = "**mpi_type_free %p";
static const char long_spc474[]  = "MPI_Type_free(datatype=%p) failed";
static const char short_spc475[] = "**mpi_type_free_keyval %p";
static const char long_spc475[]  = "MPI_Type_free_keyval(type_keyval=%p) failed";
static const char short_spc476[] = "**mpi_type_get_attr %D %K %p %p";
static const char long_spc476[]  = "MPI_Type_get_attr(%D, %K, attribute_val=%p, flag=%p) failed";
static const char short_spc477[] = "**mpi_type_get_contents %D %d %d %d %p %p %p";
static const char long_spc477[]  = "MPI_Type_get_contents(%D, max_integers=%d, max_addresses=%d, max_datatypes=%d, array_of_integers=%p, array_of_addresses=%p, array_of_datatypes=%p) failed";
static const char short_spc478[] = "**mpi_type_get_contents_c %D %c %c %c %c %p %p %p %p";
static const char long_spc478[]  = "MPI_Type_get_contents_c(%D, max_integers=%c, max_addresses=%c, max_large_counts=%c, max_datatypes=%c, array_of_integers=%p, array_of_addresses=%p, array_of_large_counts=%p, array_of_datatypes=%p) failed";
static const char short_spc479[] = "**mpi_type_get_envelope %D %p %p %p %p";
static const char long_spc479[]  = "MPI_Type_get_envelope(%D, num_integers=%p, num_addresses=%p, num_datatypes=%p, combiner=%p) failed";
static const char short_spc480[] = "**mpi_type_get_envelope_c %D %p %p %p %p %p";
static const char long_spc480[]  = "MPI_Type_get_envelope_c(%D, num_integers=%p, num_addresses=%p, num_large_counts=%p, num_datatypes=%p, combiner=%p) failed";
static const char short_spc481[] = "**mpi_type_get_extent %D %p %p";
static const char long_spc481[]  = "MPI_Type_get_extent(%D, lb=%p, extent=%p) failed";
static const char short_spc482[] = "**mpi_type_get_extent_c %D %p %p";
static const char long_spc482[]  = "MPI_Type_get_extent_c(%D, lb=%p, extent=%p) failed";
static const char short_spc483[] = "**mpi_type_get_extent_x %D %p %p";
static const char long_spc483[]  = "MPI_Type_get_extent_x(%D, lb=%p, extent=%p) failed";
static const char short_spc484[] = "**mpi_type_get_name %D %p %p";
static const char long_spc484[]  = "MPI_Type_get_name(%D, type_name=%p, resultlen=%p) failed";
static const char short_spc485[] = "**mpi_type_get_true_extent %D %p %p";
static const char long_spc485[]  = "MPI_Type_get_true_extent(%D, true_lb=%p, true_extent=%p) failed";
static const char short_spc486[] = "**mpi_type_get_true_extent_c %D %p %p";
static const char long_spc486[]  = "MPI_Type_get_true_extent_c(%D, true_lb=%p, true_extent=%p) failed";
static const char short_spc487[] = "**mpi_type_get_true_extent_x %D %p %p";
static const char long_spc487[]  = "MPI_Type_get_true_extent_x(%D, true_lb=%p, true_extent=%p) failed";
static const char short_spc488[] = "**mpi_type_indexed %d %p %p %D %p";
static const char long_spc488[]  = "MPI_Type_indexed(count=%d, array_of_blocklengths=%p, array_of_displacements=%p, %D, newtype=%p) failed";
static const char short_spc489[] = "**mpi_type_indexed_c %c %p %p %D %p";
static const char long_spc489[]  = "MPI_Type_indexed_c(count=%c, array_of_blocklengths=%p, array_of_displacements=%p, %D, newtype=%p) failed";
static const char short_spc490[] = "**mpi_type_lb %D %p";
static const char long_spc490[]  = "MPI_Type_lb(%D, displacement=%p) failed";
static const char short_spc491[] = "**mpi_type_match_size %d %d %p";
static const char long_spc491[]  = "MPI_Type_match_size(typeclass=%d, size=%d, datatype=%p) failed";
static const char short_spc492[] = "**mpi_type_set_attr %D %K %p";
static const char long_spc492[]  = "MPI_Type_set_attr(%D, %K, attribute_val=%p) failed";
static const char short_spc493[] = "**mpi_type_set_name %D %s";
static const char long_spc493[]  = "MPI_Type_set_name(%D, type_name=%s) failed";
static const char short_spc494[] = "**mpi_type_size %D %p";
static const char long_spc494[]  = "MPI_Type_size(%D, size=%p) failed";
static const char short_spc495[] = "**mpi_type_size_c %D %p";
static const char long_spc495[]  = "MPI_Type_size_c(%D, size=%p) failed";
static const char short_spc496[] = "**mpi_type_size_x %D %p";
static const char long_spc496[]  = "MPI_Type_size_x(%D, size=%p) failed";
static const char short_spc497[] = "**mpi_type_ub %D %p";
static const char long_spc497[]  = "MPI_Type_ub(%D, displacement=%p) failed";
static const char short_spc498[] = "**mpi_type_vector %d %d %d %D %p";
static const char long_spc498[]  = "MPI_Type_vector(count=%d, blocklength=%d, stride=%d, %D, newtype=%p) failed";
static const char short_spc499[] = "**mpi_type_vector_c %c %c %c %D %p";
static const char long_spc499[]  = "MPI_Type_vector_c(count=%c, blocklength=%c, stride=%c, %D, newtype=%p) failed";
static const char short_spc500[] = "**mpi_unpack %p %d %p %p %d %D %C";
static const char long_spc500[]  = "MPI_Unpack(inbuf=%p, insize=%d, position=%p, outbuf=%p, outcount=%d, %D, %C) failed";
static const char short_spc501[] = "**mpi_unpack_c %p %c %p %p %c %D %C";
static const char long_spc501[]  = "MPI_Unpack_c(inbuf=%p, insize=%c, position=%p, outbuf=%p, outcount=%c, %D, %C) failed";
static const char short_spc502[] = "**mpi_unpack_external %s %p %L %p %p %d %D";
static const char long_spc502[]  = "MPI_Unpack_external(datarep=%s, inbuf=%p, insize=%L, position=%p, outbuf=%p, outcount=%d, %D) failed";
static const char short_spc503[] = "**mpi_unpack_external_c %s %p %c %p %p %c %D";
static const char long_spc503[]  = "MPI_Unpack_external_c(datarep=%s, inbuf=%p, insize=%c, position=%p, outbuf=%p, outcount=%c, %D) failed";
static const char short_spc504[] = "**mpi_unpublish_name %s %I %s";
static const char long_spc504[]  = "MPI_Unpublish_name(service_name=%s, %I, port_name=%s) failed";
static const char short_spc505[] = "**mpi_wait %p %p";
static const char long_spc505[]  = "MPI_Wait(request=%p, status=%p) failed";
static const char short_spc506[] = "**mpi_waitall %d %p %p";
static const char long_spc506[]  = "MPI_Waitall(count=%d, array_of_requests=%p, array_of_statuses=%p) failed";
static const char short_spc507[] = "**mpi_waitany %d %p %p %p";
static const char long_spc507[]  = "MPI_Waitany(count=%d, array_of_requests=%p, indx=%p, status=%p) failed";
static const char short_spc508[] = "**mpi_waitsome %d %p %p %p %p";
static const char long_spc508[]  = "MPI_Waitsome(incount=%d, array_of_requests=%p, outcount=%p, array_of_indices=%p, array_of_statuses=%p) failed";
static const char short_spc509[] = "**mpi_win_allocate %L %d %I %C %p %p";
static const char long_spc509[]  = "MPI_Win_allocate(size=%L, disp_unit=%d, %I, %C, baseptr=%p, win=%p) failed";
static const char short_spc510[] = "**mpi_win_allocate_c %L %L %I %C %p %p";
static const char long_spc510[]  = "MPI_Win_allocate_c(size=%L, disp_unit=%L, %I, %C, baseptr=%p, win=%p) failed";
static const char short_spc511[] = "**mpi_win_allocate_shared %L %d %I %C %p %p";
static const char long_spc511[]  = "MPI_Win_allocate_shared(size=%L, disp_unit=%d, %I, %C, baseptr=%p, win=%p) failed";
static const char short_spc512[] = "**mpi_win_allocate_shared_c %L %L %I %C %p %p";
static const char long_spc512[]  = "MPI_Win_allocate_shared_c(size=%L, disp_unit=%L, %I, %C, baseptr=%p, win=%p) failed";
static const char short_spc513[] = "**mpi_win_attach %W %p %L";
static const char long_spc513[]  = "MPI_Win_attach(%W, base=%p, size=%L) failed";
static const char short_spc514[] = "**mpi_win_call_errhandler %W %d";
static const char long_spc514[]  = "MPI_Win_call_errhandler(%W, errorcode=%d) failed";
static const char short_spc515[] = "**mpi_win_complete %W";
static const char long_spc515[]  = "MPI_Win_complete(%W) failed";
static const char short_spc516[] = "**mpi_win_create %p %L %d %I %C %p";
static const char long_spc516[]  = "MPI_Win_create(base=%p, size=%L, disp_unit=%d, %I, %C, win=%p) failed";
static const char short_spc517[] = "**mpi_win_create_c %p %L %L %I %C %p";
static const char long_spc517[]  = "MPI_Win_create_c(base=%p, size=%L, disp_unit=%L, %I, %C, win=%p) failed";
static const char short_spc518[] = "**mpi_win_create_dynamic %I %C %p";
static const char long_spc518[]  = "MPI_Win_create_dynamic(%I, %C, win=%p) failed";
static const char short_spc519[] = "**mpi_win_create_errhandler %p %p";
static const char long_spc519[]  = "MPI_Win_create_errhandler(win_errhandler_fn=%p, errhandler=%p) failed";
static const char short_spc520[] = "**mpi_win_create_keyval %p %p %p %p";
static const char long_spc520[]  = "MPI_Win_create_keyval(win_copy_attr_fn=%p, win_delete_attr_fn=%p, win_keyval=%p, extra_state=%p) failed";
static const char short_spc521[] = "**mpi_win_delete_attr %W %K";
static const char long_spc521[]  = "MPI_Win_delete_attr(%W, %K) failed";
static const char short_spc522[] = "**mpi_win_detach %W %p";
static const char long_spc522[]  = "MPI_Win_detach(%W, base=%p) failed";
static const char short_spc523[] = "**mpi_win_fence %A %W";
static const char long_spc523[]  = "MPI_Win_fence(%A, %W) failed";
static const char short_spc524[] = "**mpi_win_flush %d %W";
static const char long_spc524[]  = "MPI_Win_flush(rank=%d, %W) failed";
static const char short_spc525[] = "**mpi_win_flush_all %W";
static const char long_spc525[]  = "MPI_Win_flush_all(%W) failed";
static const char short_spc526[] = "**mpi_win_flush_local %d %W";
static const char long_spc526[]  = "MPI_Win_flush_local(rank=%d, %W) failed";
static const char short_spc527[] = "**mpi_win_flush_local_all %W";
static const char long_spc527[]  = "MPI_Win_flush_local_all(%W) failed";
static const char short_spc528[] = "**mpi_win_free %p";
static const char long_spc528[]  = "MPI_Win_free(win=%p) failed";
static const char short_spc529[] = "**mpi_win_free_keyval %p";
static const char long_spc529[]  = "MPI_Win_free_keyval(win_keyval=%p) failed";
static const char short_spc530[] = "**mpi_win_get_attr %W %K %p %p";
static const char long_spc530[]  = "MPI_Win_get_attr(%W, %K, attribute_val=%p, flag=%p) failed";
static const char short_spc531[] = "**mpi_win_get_errhandler %W %p";
static const char long_spc531[]  = "MPI_Win_get_errhandler(%W, errhandler=%p) failed";
static const char short_spc532[] = "**mpi_win_get_group %W %p";
static const char long_spc532[]  = "MPI_Win_get_group(%W, group=%p) failed";
static const char short_spc533[] = "**mpi_win_get_info %W %p";
static const char long_spc533[]  = "MPI_Win_get_info(%W, info_used=%p) failed";
static const char short_spc534[] = "**mpi_win_get_name %W %p %p";
static const char long_spc534[]  = "MPI_Win_get_name(%W, win_name=%p, resultlen=%p) failed";
static const char short_spc535[] = "**mpi_win_lock %d %d %A %W";
static const char long_spc535[]  = "MPI_Win_lock(lock_type=%d, rank=%d, %A, %W) failed";
static const char short_spc536[] = "**mpi_win_lock_all %A %W";
static const char long_spc536[]  = "MPI_Win_lock_all(%A, %W) failed";
static const char short_spc537[] = "**mpi_win_post %G %A %W";
static const char long_spc537[]  = "MPI_Win_post(%G, %A, %W) failed";
static const char short_spc538[] = "**mpi_win_set_attr %W %K %p";
static const char long_spc538[]  = "MPI_Win_set_attr(%W, %K, attribute_val=%p) failed";
static const char short_spc539[] = "**mpi_win_set_errhandler %W %E";
static const char long_spc539[]  = "MPI_Win_set_errhandler(%W, %E) failed";
static const char short_spc540[] = "**mpi_win_set_info %W %I";
static const char long_spc540[]  = "MPI_Win_set_info(%W, %I) failed";
static const char short_spc541[] = "**mpi_win_set_name %W %s";
static const char long_spc541[]  = "MPI_Win_set_name(%W, win_name=%s) failed";
static const char short_spc542[] = "**mpi_win_shared_query %W %d %p %p %p";
static const char long_spc542[]  = "MPI_Win_shared_query(%W, rank=%d, size=%p, disp_unit=%p, baseptr=%p) failed";
static const char short_spc543[] = "**mpi_win_shared_query_c %W %d %p %p %p";
static const char long_spc543[]  = "MPI_Win_shared_query_c(%W, rank=%d, size=%p, disp_unit=%p, baseptr=%p) failed";
static const char short_spc544[] = "**mpi_win_start %G %A %W";
static const char long_spc544[]  = "MPI_Win_start(%G, %A, %W) failed";
static const char short_spc545[] = "**mpi_win_sync %W";
static const char long_spc545[]  = "MPI_Win_sync(%W) failed";
static const char short_spc546[] = "**mpi_win_test %W %p";
static const char long_spc546[]  = "MPI_Win_test(%W, flag=%p) failed";
static const char short_spc547[] = "**mpi_win_unlock %d %W";
static const char long_spc547[]  = "MPI_Win_unlock(rank=%d, %W) failed";
static const char short_spc548[] = "**mpi_win_unlock_all %W";
static const char long_spc548[]  = "MPI_Win_unlock_all(%W) failed";
static const char short_spc549[] = "**mpi_win_wait %W";
static const char long_spc549[]  = "MPI_Win_wait(%W) failed";
static const char short_spc550[] = "**mpix_comm_agree %C %p";
static const char long_spc550[]  = "MPIX_Comm_agree(%C, flag=%p) failed";
static const char short_spc551[] = "**mpix_comm_failure_ack %C";
static const char long_spc551[]  = "MPIX_Comm_failure_ack(%C) failed";
static const char short_spc552[] = "**mpix_comm_failure_get_acked %C %p";
static const char long_spc552[]  = "MPIX_Comm_failure_get_acked(%C, failedgrp=%p) failed";
static const char short_spc553[] = "**mpix_comm_revoke %C";
static const char long_spc553[]  = "MPIX_Comm_revoke(%C) failed";
static const char short_spc554[] = "**mpix_comm_shrink %C %p";
static const char long_spc554[]  = "MPIX_Comm_shrink(%C, newcomm=%p) failed";
static const char short_spc555[] = "**mpix_delete_error_class %d";
static const char long_spc555[]  = "MPIX_Delete_error_class(errorclass=%d) failed";
static const char short_spc556[] = "**mpix_delete_error_code %d";
static const char long_spc556[]  = "MPIX_Delete_error_code(errorcode=%d) failed";
static const char short_spc557[] = "**mpix_delete_error_string %d";
static const char long_spc557[]  = "MPIX_Delete_error_string(errorcode=%d) failed";
static const char short_spc558[] = "**mpix_gpu_query_support %d %p";
static const char long_spc558[]  = "MPIX_GPU_query_support(gpu_type=%d, is_supported=%p) failed";
static const char short_spc559[] = "**mpix_grequest_class_allocate %x %p %p";
static const char long_spc559[]  = "MPIX_Grequest_class_allocate(%x, extra_state=%p, request=%p) failed";
static const char short_spc560[] = "**mpix_grequest_class_create %p %p %p %p %p %p";
static const char long_spc560[]  = "MPIX_Grequest_class_create(query_fn=%p, free_fn=%p, cancel_fn=%p, poll_fn=%p, wait_fn=%p, greq_class=%p) failed";
static const char short_spc561[] = "**mpix_grequest_start %p %p %p %p %p %p %p";
static const char long_spc561[]  = "MPIX_Grequest_start(query_fn=%p, free_fn=%p, cancel_fn=%p, poll_fn=%p, wait_fn=%p, extra_state=%p, request=%p) failed";
static const char short_spc562[] = "**msgnotreq %d";
static const char long_spc562[]  = " Invalid MPI_Request at array index %d (MPI_Message passed)";
static const char short_spc563[] = "**namepubfile %s %s %s";
static const char long_spc563[]  = "Unable to publish service name %s using file %s for reason %s";
static const char short_spc564[] = "**namepubnotfound %s";
static const char long_spc564[]  = "Lookup failed for service name %s";
static const char short_spc565[] = "**namepubnotpub %s";
static const char long_spc565[]  = "Lookup failed for service name %s";
static const char short_spc566[] = "**namepubnotunpub %s";
static const char long_spc566[]  = "Failed to unpublish service name %s";
static const char short_spc567[] = "**nomem %d";
static const char long_spc567[]  = "Out of memory (unable to allocate %d bytes)";
static const char short_spc568[] = "**nomem %s";
static const char long_spc568[]  = "Out of memory (unable to allocate a '%s')";
static const char short_spc569[] = "**nomem %s %d";
static const char long_spc569[]  = "Out of memory (unable to allocate a '%s' of size %d)";
static const char short_spc570[] = "**nomem2 %d %s";
static const char long_spc570[]  = "Unable to allocate %d bytes of memory for %s (probably out of memory)";
static const char short_spc571[] = "**nomemuereq %d";
static const char long_spc571[]  = "Failed to allocate memory for an unexpected message. %d unexpected messages queued.";
static const char short_spc572[] = "**notimpl %s";
static const char long_spc572[]  = "Function %s not implemented";
static const char short_spc573[] = "**notsame %s %s";
static const char long_spc573[]  = "Inconsistent arguments %s to collective routine %s";
static const char short_spc574[] = "**nullptr %s";
static const char long_spc574[]  = "Null pointer in parameter %s";
static const char short_spc575[] = "**nullptrtype %s";
static const char long_spc575[]  = "Null %s pointer";
static const char short_spc576[] = "**ofi_avclose %s %d %s %s";
static const char long_spc576[]  = "OFI av close failed (%s:%d:%s:%s)";
static const char short_spc577[] = "**ofi_avmap %s %d %s %s";
static const char long_spc577[]  = "OFI address vector map failed (%s:%d:%s:%s)";
static const char short_spc578[] = "**ofi_avopen %s %d %s %s";
static const char long_spc578[]  = "OFI address vector open failed (%s:%d:%s:%s)";
static const char short_spc579[] = "**ofi_bind %s %d %s %s";
static const char long_spc579[]  = "OFI resource bind failed (%s:%d:%s:%s)";
static const char short_spc580[] = "**ofi_cancel %s %d %s %s";
static const char long_spc580[]  = "OFI cancel failed (%s:%d:%s:%s)";
static const char short_spc581[] = "**ofi_cqclose %s %d %s %s";
static const char long_spc581[]  = "OFI cq close failed (%s:%d:%s:%s)";
static const char short_spc582[] = "**ofi_domainclose %s %d %s %s";
static const char long_spc582[]  = "OFI domain close failed (%s:%d:%s:%s)";
static const char short_spc583[] = "**ofi_ep_enable %s %d %s %s";
static const char long_spc583[]  = "OFI endpoint enable failed (%s:%d:%s:%s)";
static const char short_spc584[] = "**ofi_epclose %s %d %s %s";
static const char long_spc584[]  = "OFI endpoint close failed (%s:%d:%s:%s)";
static const char short_spc585[] = "**ofi_fabricclose %s %d %s %s";
static const char long_spc585[]  = "OFI fabric close failed (%s:%d:%s:%s)";
static const char short_spc586[] = "**ofi_getinfo %s %d %s %s";
static const char long_spc586[]  = "OFI getinfo() failed (%s:%d:%s:%s)";
static const char short_spc587[] = "**ofi_getname %s %d %s %s";
static const char long_spc587[]  = "OFI get endpoint name failed (%s:%d:%s:%s)";
static const char short_spc588[] = "**ofi_opencq %s %d %s %s";
static const char long_spc588[]  = "OFI event queue create failed (%s:%d:%s:%s)";
static const char short_spc589[] = "**ofi_opendomain %s %d %s %s";
static const char long_spc589[]  = "OFI domain open failed (%s:%d:%s:%s)";
static const char short_spc590[] = "**ofi_openep %s %d %s %s";
static const char long_spc590[]  = "OFI endpoint open failed (%s:%d:%s:%s)";
static const char short_spc591[] = "**ofi_openfabric %s %d %s %s";
static const char long_spc591[]  = "OFI fabric open failed (%s:%d:%s:%s)";
static const char short_spc592[] = "**ofi_peek %s %d %s %s";
static const char long_spc592[]  = "OFI peek failed (%s:%d:%s:%s)";
static const char short_spc593[] = "**ofi_poll %s %d %s %s";
static const char long_spc593[]  = "OFI poll failed (%s:%d:%s:%s)";
static const char short_spc594[] = "**ofi_trecv %s %d %s %s";
static const char long_spc594[]  = "OFI tagged recvfrom failed (%s:%d:%s:%s)";
static const char short_spc595[] = "**ofi_tsend %s %d %s %s";
static const char long_spc595[]  = "OFI tagged sendto failed (%s:%d:%s:%s)";
static const char short_spc596[] = "**ofid_alias %s %d %s %s";
static const char long_spc596[]  = "OFI cq alias failed (%s:%d:%s:%s)";
static const char short_spc597[] = "**ofid_avclose %s %d %s %s";
static const char long_spc597[]  = "OFI av close failed (%s:%d:%s:%s)";
static const char short_spc598[] = "**ofid_avlookup %s %d %s %s";
static const char long_spc598[]  = "OFI address vector lookup failed (%s:%d:%s:%s)";
static const char short_spc599[] = "**ofid_avmap %s %d %s %s";
static const char long_spc599[]  = "OFI address vector map failed (%s:%d:%s:%s)";
static const char short_spc600[] = "**ofid_avopen %s %d %s %s";
static const char long_spc600[]  = "OFI address vector open failed (%s:%d:%s:%s)";
static const char short_spc601[] = "**ofid_avsync %s %d %s %s";
static const char long_spc601[]  = "OFI address vector sync failed (%s:%d:%s:%s)";
static const char short_spc602[] = "**ofid_bind %s %d %s %s";
static const char long_spc602[]  = "OFI resource bind failed (%s:%d:%s:%s)";
static const char short_spc603[] = "**ofid_cancel %s %d %s %s";
static const char long_spc603[]  = "OFI cancel failed (%s:%d:%s:%s)";
static const char short_spc604[] = "**ofid_cntr_wait %s %d %s %s";
static const char long_spc604[]  = "OFI OFI Counter wait failed (%s:%d:%s:%s)";
static const char short_spc605[] = "**ofid_cqclose %s %d %s %s";
static const char long_spc605[]  = "OFI cq close failed (%s:%d:%s:%s)";
static const char short_spc606[] = "**ofid_ctrlcancel %s %d %s %s";
static const char long_spc606[]  = "OFI control cancel failed (%s:%d:%s:%s)";
static const char short_spc607[] = "**ofid_domainclose %s %d %s %s";
static const char long_spc607[]  = "OFI domain close failed (%s:%d:%s:%s)";
static const char short_spc608[] = "**ofid_ep %s %d %s %s";
static const char long_spc608[]  = "OFI endpoint open failed (%s:%d:%s:%s)";
static const char short_spc609[] = "**ofid_ep_enable %s %d %s %s";
static const char long_spc609[]  = "OFI EP enable failed (%s:%d:%s:%s)";
static const char short_spc610[] = "**ofid_epclose %s %d %s %s";
static const char long_spc610[]  = "OFI endpoint close failed (%s:%d:%s:%s)";
static const char short_spc611[] = "**ofid_epsync %s %d %s %s";
static const char long_spc611[]  = "OFI endpoint synchronization failed (%s:%d:%s:%s)";
static const char short_spc612[] = "**ofid_fabric %s %d %s %s";
static const char long_spc612[]  = "OFI fi_fabric failed (%s:%d:%s:%s)";
static const char short_spc613[] = "**ofid_getinfo %s %d %s %s";
static const char long_spc613[]  = "OFI fi_getinfo() failed (%s:%d:%s:%s)";
static const char short_spc614[] = "**ofid_getname %s %d %s %s";
static const char long_spc614[]  = "OFI get endpoint name failed (%s:%d:%s:%s)";
static const char short_spc615[] = "**ofid_getopt %s %d %s %s";
static const char long_spc615[]  = "OFI getopt failed (%s:%d:%s:%s)";
static const char short_spc616[] = "**ofid_inject %s %d %s %s";
static const char long_spc616[]  = "OFI inject failed (%s:%d:%s:%s)";
static const char short_spc617[] = "**ofid_mr_reg %s %d %s %s";
static const char long_spc617[]  = "OFI memory registration failed (%s:%d:%s:%s)";
static const char short_spc618[] = "**ofid_mr_unreg %s %d %s %s";
static const char long_spc618[]  = "OFI memory deregistration failed (%s:%d:%s:%s)";
static const char short_spc619[] = "**ofid_opencq %s %d %s %s";
static const char long_spc619[]  = "OFI event queue create failed (%s:%d:%s:%s)";
static const char short_spc620[] = "**ofid_openct %s %d %s %s";
static const char long_spc620[]  = "OFI event counter create failed (%s:%d:%s:%s)";
static const char short_spc621[] = "**ofid_opendomain %s %d %s %s";
static const char long_spc621[]  = "OFI fi_open domain failed (%s:%d:%s:%s)";
static const char short_spc622[] = "**ofid_peek %s %d %s %s";
static const char long_spc622[]  = "OFI peek failed (%s:%d:%s:%s)";
static const char short_spc623[] = "**ofid_pmi %s %d %s %s";
static const char long_spc623[]  = "pmi failed (%s:%d:%s:%s)";
static const char short_spc624[] = "**ofid_poll %s %d %s %s";
static const char long_spc624[]  = "OFI poll failed (%s:%d:%s:%s)";
static const char short_spc625[] = "**ofid_prepost %s %d %s %s";
static const char long_spc625[]  = "OFI preposting receives failed (%s:%d:%s:%s)";
static const char short_spc626[] = "**ofid_rdma_atomicto %s %d %s %s";
static const char long_spc626[]  = "OFI rdma atomicto failed (%s:%d:%s:%s)";
static const char short_spc627[] = "**ofid_rdma_cswap %s %d %s %s";
static const char long_spc627[]  = "OFI rdma cswap failed (%s:%d:%s:%s)";
static const char short_spc628[] = "**ofid_rdma_inject_write %s %d %s %s";
static const char long_spc628[]  = "OFI rdma write immediate failed (%s:%d:%s:%s)";
static const char short_spc629[] = "**ofid_rdma_readfrom %s %d %s %s";
static const char long_spc629[]  = "OFI read failed (%s:%d:%s:%s)";
static const char short_spc630[] = "**ofid_rdma_write %s %d %s %s";
static const char long_spc630[]  = "OFI rdma write failed (%s:%d:%s:%s)";
static const char short_spc631[] = "**ofid_send %s %d %s %s";
static const char long_spc631[]  = "OFI send failed (%s:%d:%s:%s)";
static const char short_spc632[] = "**ofid_sendv %s %d %s %s";
static const char long_spc632[]  = "OFI send failed (%s:%d:%s:%s)";
static const char short_spc633[] = "**ofid_setopt %s %d %s %s";
static const char long_spc633[]  = "OFI setopt failed (%s:%d:%s:%s)";
static const char short_spc634[] = "**ofid_tinject %s %d %s %s";
static const char long_spc634[]  = "OFI tagged inject failed (%s:%d:%s:%s)";
static const char short_spc635[] = "**ofid_trecv %s %d %s %s";
static const char long_spc635[]  = "OFI tagged recv failed (%s:%d:%s:%s)";
static const char short_spc636[] = "**ofid_trecvsync %s %d %s %s";
static const char long_spc636[]  = "OFI tagged recv sync failed (%s:%d:%s:%s)";
static const char short_spc637[] = "**ofid_tsend %s %d %s %s";
static const char long_spc637[]  = "OFI tagged send failed (%s:%d:%s:%s)";
static const char short_spc638[] = "**ofid_tsendsync %s %d %s %s";
static const char long_spc638[]  = "OFI tagged send sync failed (%s:%d:%s:%s)";
static const char short_spc639[] = "**opnotpredefined %d";
static const char long_spc639[]  = "only predefined ops are valid (op = %d)";
static const char short_spc640[] = "**opundefined %s";
static const char long_spc640[]  = "MPI_Op %s operation not defined for this datatype ";
static const char short_spc641[] = "**parse_thread_affinity %s";
static const char long_spc641[]  = "Failed to parse async thread affinity string [%s]";
static const char short_spc642[] = "**partitioninvalid %d";
static const char long_spc642[]  = " Invalid partition, value is %d ";
static const char short_spc643[] = "**partitioninvalid %d %d";
static const char long_spc643[]  = " Invalid partition range, values are %d %d";
static const char short_spc644[] = "**pglookup %s";
static const char long_spc644[]  = "unable to find the process group structure with id <%s>";
static const char short_spc645[] = "**pmi2_info_getjobattr %d";
static const char long_spc645[]  = " PMI2_Info_GetJobAttr returned %d";
static const char short_spc646[] = "**pmi_barrier %d";
static const char long_spc646[]  = "PMI_Barrier returned %d";
static const char short_spc647[] = "**pmi_get_appnum %d";
static const char long_spc647[]  = "PMI_Get_appnum returned %d";
static const char short_spc648[] = "**pmi_get_id_length_max %d";
static const char long_spc648[]  = "PMI_Get_id_length_max returned %d";
static const char short_spc649[] = "**pmi_get_rank %d";
static const char long_spc649[]  = "PMI_Get_rank returned %d";
static const char short_spc650[] = "**pmi_get_size %d";
static const char long_spc650[]  = "PMI_Get_size returned %d";
static const char short_spc651[] = "**pmi_get_universe_size %d";
static const char long_spc651[]  = "PMI_Get_universe_size returned %d";
static const char short_spc652[] = "**pmi_getjobattr %d";
static const char long_spc652[]  = " PMI2 GetJobAttr failed: %d";
static const char short_spc653[] = "**pmi_init %d";
static const char long_spc653[]  = "PMI_Init returned %d";
static const char short_spc654[] = "**pmi_job_getid %d";
static const char long_spc654[]  = "PMI2_Job_GetId returned %d";
static const char short_spc655[] = "**pmi_kvs_commit %d";
static const char long_spc655[]  = "PMI_KVS_Commit returned %d";
static const char short_spc656[] = "**pmi_kvs_get %d";
static const char long_spc656[]  = "PMI_KVS_Get returned %d";
static const char short_spc657[] = "**pmi_kvs_get_key_length_max %d";
static const char long_spc657[]  = "PMI_KVS_Get_key_length_max returned %d";
static const char short_spc658[] = "**pmi_kvs_get_my_name %d";
static const char long_spc658[]  = "PMI_KVS_Get_my_name returned %d";
static const char short_spc659[] = "**pmi_kvs_get_name_length_max %d";
static const char long_spc659[]  = "PMI_KVS_Get_name_length_max returned %d";
static const char short_spc660[] = "**pmi_kvs_get_value_length_max %d";
static const char long_spc660[]  = "PMI_KVS_Get_value_length_max returned %d";
static const char short_spc661[] = "**pmi_kvs_put %d";
static const char long_spc661[]  = "PMI_KVS_Put returned %d";
static const char short_spc662[] = "**pmi_kvsfence %d";
static const char long_spc662[]  = " PMI2 KVS_Fence failed: %d";
static const char short_spc663[] = "**pmi_kvsget %d";
static const char long_spc663[]  = " PMI2 KVS_Get failed: %d";
static const char short_spc664[] = "**pmi_kvsget %s";
static const char long_spc664[]  = " PMI2 KVS_Get failed: %s";
static const char short_spc665[] = "**pmi_kvsput %d";
static const char long_spc665[]  = " PMI2 KVS_Put failed: %d";
static const char short_spc666[] = "**pmi_spawn_multiple %d";
static const char long_spc666[]  = "PMI_Spawn_multiple returned %d";
static const char short_spc667[] = "**pmix_commit %d";
static const char long_spc667[]  = "PMIx_Commit returned %d";
static const char short_spc668[] = "**pmix_fence %d";
static const char long_spc668[]  = "PMIx_Fence returned %d";
static const char short_spc669[] = "**pmix_get %d";
static const char long_spc669[]  = "PMIx_Get returned %d";
static const char short_spc670[] = "**pmix_init %d";
static const char long_spc670[]  = "PMIX_Init returned %d";
static const char short_spc671[] = "**pmix_put %d";
static const char long_spc671[]  = "PMIx_Put returned %d";
static const char short_spc672[] = "**pmix_resolve_nodes %d";
static const char long_spc672[]  = " PMIx_Resolve_nodes returned %d";
static const char short_spc673[] = "**pmix_resolve_peers %d";
static const char long_spc673[]  = " PMIx_Resolve_peers returned %d";
static const char short_spc674[] = "**poll %s";
static const char long_spc674[]  = "poll of socket fds failed - %s";
static const char short_spc675[] = "**portexist %s";
static const char long_spc675[]  = "Named port %s does not exist";
static const char short_spc676[] = "**pthread_mutex %s";
static const char long_spc676[]  = "pthread mutex routine failed (%s)";
static const char short_spc677[] = "**qmpi_invalid_name %s";
static const char long_spc677[]  = " tool name is invalid (name=%s)";
static const char short_spc678[] = "**rangedup %d %d %d";
static const char long_spc678[]  = "The range array specifies duplicate entries; process %d specified in range array %d was previously specified in range array %d";
static const char short_spc679[] = "**rangeendinvalid %d %d %d";
static const char long_spc679[]  = "The %dth element of a range array ends at %d but must be nonnegative and less than %d";
static const char short_spc680[] = "**rangestartinvalid %d %d %d";
static const char long_spc680[]  = "The %dth element of a range array starts at %d but must be nonnegative and less than %d";
static const char short_spc681[] = "**rank %d %d";
static const char long_spc681[]  = "Invalid rank has value %d but must be nonnegative and less than %d";
static const char short_spc682[] = "**rankarray %d %d %d";
static const char long_spc682[]  = "Invalid rank in rank array at index %d; value is %d but must be in the range 0 to %d";
static const char short_spc683[] = "**rankdup %d %d %d";
static const char long_spc683[]  = "Duplicate ranks in rank array at index %d, has value %d which is also the value at index %d";
static const char short_spc684[] = "**ranklocal %d %d";
static const char long_spc684[]  = "Error specifying local_leader; rank given was %d but must be in the range 0 to %d";
static const char short_spc685[] = "**rankremote %d %d";
static const char long_spc685[]  = "Error specifying remote_leader; rank given was %d but must be in the range 0 to %d";
static const char short_spc686[] = "**read %d %s";
static const char long_spc686[]  = "read from socket failed - nread=%d %s";
static const char short_spc687[] = "**read %s";
static const char long_spc687[]  = "read from socket failed - %s";
static const char short_spc688[] = "**request %d";
static const char long_spc688[]  = "Invalid MPI_Request in array element %d (from 0)";
static const char short_spc689[] = "**request_invalid_kind %d";
static const char long_spc689[]  = "The supplied request was invalid (kind=%d)";
static const char short_spc690[] = "**request_invalid_kind %d %d";
static const char long_spc690[]  = "The supplied request in array element %d was invalid (kind=%d)";
static const char short_spc691[] = "**rmasize %d";
static const char long_spc691[]  = "Invalid size argument in RMA call (value is %d)";
static const char short_spc692[] = "**rmatypenotatomic %D";
static const char long_spc692[]  = " Datatype (%D) not permitted for atomic operations";
static const char short_spc693[] = "**root %d";
static const char long_spc693[]  = "Invalid root (value given was %d)";
static const char short_spc694[] = "**rsendnomatch %d %d";
static const char long_spc694[]  = "Ready send from source %d and with tag %d had no matching receive";
static const char short_spc695[] = "**sem_destroy %s";
static const char long_spc695[]  = "sem_destroy() failed %s";
static const char short_spc696[] = "**sem_init %s";
static const char long_spc696[]  = "sem_init() failed %s";
static const char short_spc697[] = "**sem_post %s";
static const char long_spc697[]  = "sem_post() failed %s";
static const char short_spc698[] = "**sem_wait %s";
static const char long_spc698[]  = "sem_wait() failed %s";
static const char short_spc699[] = "**set_thread_affinity %d";
static const char long_spc699[]  = "Failed to set the async thread affinity to the logical processor [%d]";
static const char short_spc700[] = "**signal %s";
static const char long_spc700[]  = "signal() failed: %s";
static const char short_spc701[] = "**snprintf %d";
static const char long_spc701[]  = "snprintf returned %d";
static const char short_spc702[] = "**sock_accept %s";
static const char long_spc702[]  = "accept of socket fd failed - %s";
static const char short_spc703[] = "**sock_connect %d %s";
static const char long_spc703[]  = "connect failed - %s (errno %d)";
static const char short_spc704[] = "**sock_create %s %d";
static const char long_spc704[]  = "unable to create a socket, %s (errno %d)";
static const char short_spc705[] = "**sock_gethost %s %d";
static const char long_spc705[]  = "gethostname failed, %s (errno %d)";
static const char short_spc706[] = "**sock|badiovn %d %d %d";
static const char long_spc706[]  = "size of iov is invalid (set=%d,sock=%d,iov_n=%d)";
static const char short_spc707[] = "**sock|badlen %d %d %d %d";
static const char long_spc707[]  = "bad length parameter(s) (set=%d,sock=%d,min=%d,max=%d)";
static const char short_spc708[] = "**sock|badport %d";
static const char long_spc708[]  = "port number is out of range (sock=%d)";
static const char short_spc709[] = "**sock|closing %d %d";
static const char long_spc709[]  = "sock is in the process of being closed locally (set=%d,sock=%d)";
static const char short_spc710[] = "**sock|closing_already %d %d";
static const char long_spc710[]  = "a close operation is already post (set=%d,sock=%d)";
static const char short_spc711[] = "**sock|connclosed %d %d";
static const char long_spc711[]  = "connection closed by peer (set=%d,sock=%d)";
static const char short_spc712[] = "**sock|listener_bad_sock %d %d";
static const char long_spc712[]  = "supplied sock is not a listener (set=%d,sock=%d)";
static const char short_spc713[] = "**sock|listener_bad_state %d %d %d";
static const char long_spc713[]  = "supplied listener sock is in a bad state (set=%d,sock=%d,state=%d)";
static const char short_spc714[] = "**sock|listener_read %d %d";
static const char long_spc714[]  = "read operation not allowed on a listener (set=%d,sock=%d)";
static const char short_spc715[] = "**sock|listener_write %d %d";
static const char long_spc715[]  = "write operation not allowed on a listener (set=%d,sock=%d)";
static const char short_spc716[] = "**sock|notconnected %d %d";
static const char long_spc716[]  = "sock is not connected (set=%d,sock=%d)";
static const char short_spc717[] = "**sock|osnomem %s %d %d";
static const char long_spc717[]  = "operating system routine %s failed due to lack of memory (set=%d,sock=%d)";
static const char short_spc718[] = "**sock|poll|accept %d %s";
static const char long_spc718[]  = "accept failed to acquire a new socket (errno=%d:%s)";
static const char short_spc719[] = "**sock|poll|badbuf %d %d %d %s";
static const char long_spc719[]  = "the supplied buffer contains invalid memory (set=%d,sock=%d,errno=%d:%s)";
static const char short_spc720[] = "**sock|poll|badhandle %d %d %d";
static const char long_spc720[]  = "sock contains an invalid file descriptor (set=%d,sock=%d,fd=%d)";
static const char short_spc721[] = "**sock|poll|badhandle %d %d %d %d";
static const char long_spc721[]  = "sock contains an invalid file descriptor (set=%d,sock=%d,fd=%d:%d)";
static const char short_spc722[] = "**sock|poll|bind %d %d %s";
static const char long_spc722[]  = "unable to bind socket to port (port=%d,errno=%d:%s)";
static const char short_spc723[] = "**sock|poll|connclosed %d %d %d %s";
static const char long_spc723[]  = "connection closed by peer (set=%d,sock=%d,errno=%d:%s)";
static const char short_spc724[] = "**sock|poll|connfailed %d %d %d %s";
static const char long_spc724[]  = "connection failure (set=%d,sock=%d,errno=%d:%s)";
static const char short_spc725[] = "**sock|poll|connrefused %d %d %s";
static const char long_spc725[]  = "connection refused (set=%d,sock=%d,host=%s)";
static const char short_spc726[] = "**sock|poll|eqfail %d %d %d";
static const char long_spc726[]  = "fatal error: failed to enqueue an event; event was lost (set=%d,sock=%d,op=%d)";
static const char short_spc727[] = "**sock|poll|listen %d %s";
static const char long_spc727[]  = "listen() failed (errno=%d:%s)";
static const char short_spc728[] = "**sock|poll|nodelay %d %s";
static const char long_spc728[]  = "unable to set TCP no delay attribute on socket (errno=%d:%s)";
static const char short_spc729[] = "**sock|poll|nonblock %d %s";
static const char long_spc729[]  = "unable to set socket to nonblocking (errno=%d:%s)";
static const char short_spc730[] = "**sock|poll|oserror %d %d %d %s";
static const char long_spc730[]  = "unexpected operating system error (set=%d,sock=%d,errno=%d:%s)";
static const char short_spc731[] = "**sock|poll|oserror %d %s";
static const char long_spc731[]  = "unexpected operating system error (errno=%d:%s)";
static const char short_spc732[] = "**sock|poll|oserror %s %d %d %d %s";
static const char long_spc732[]  = "unpected operating system error from %s (set=%d,sock=%d,errno=%d:%s)";
static const char short_spc733[] = "**sock|poll|osnomem %d %d %d %s";
static const char long_spc733[]  = "operating system routine failed due to lack of memory (set=%d,sock=%d,errno=%d:%s)";
static const char short_spc734[] = "**sock|poll|pipe %d %s";
static const char long_spc734[]  = "unable to allocate pipe to wakeup a blocking poll() (errno=%d:%s)";
static const char short_spc735[] = "**sock|poll|pipenonblock %d %s";
static const char long_spc735[]  = "unable to set wakeup pipe to nonblocking (errno=%d:%s)";
static const char short_spc736[] = "**sock|poll|reuseaddr %d %s";
static const char long_spc736[]  = "unable to set reuseaddr attribute on socket (errno=%d:%s)";
static const char short_spc737[] = "**sock|poll|setrcvbufsz %d %d %s";
static const char long_spc737[]  = " unable to set the receive socket buffer size (size=%d,errno=%d:%s)";
static const char short_spc738[] = "**sock|poll|setsndbufsz %d %d %s";
static const char long_spc738[]  = " unable to set the send socket buffer size (size=%d,errno=%d:%s)";
static const char short_spc739[] = "**sock|poll|socket %d %s";
static const char long_spc739[]  = "unable to obtain new socket (errno=%d:%s)";
static const char short_spc740[] = "**sock|poll|unhandledstate %d";
static const char long_spc740[]  = "encountered an unexpected state (%d)";
static const char short_spc741[] = "**sock|poll|unhandledtype %d";
static const char long_spc741[]  = "encountered an unexpected sock type (%d)";
static const char short_spc742[] = "**sock|reads %d %d";
static const char long_spc742[]  = "attempt to perform multiple simultaneous reads (set=%d,sock=%d)";
static const char short_spc743[] = "**sock|writes %d %d";
static const char long_spc743[]  = "attempt to perform multiple simultaneous writes (set=%d,sock=%d)";
static const char short_spc744[] = "**splittype %d";
static const char long_spc744[]  = "Invalid split_type argument (%d)";
static const char short_spc745[] = "**storageorder %d";
static const char long_spc745[]  = " Invalid storage order (%d)";
static const char short_spc746[] = "**stride %d %d %d";
static const char long_spc746[]  = "Range (start = %d, end = %d, stride = %d) does not terminate";
static const char short_spc747[] = "**tag %d";
static const char long_spc747[]  = "Invalid tag, value is %d";
static const char short_spc748[] = "**thread_level %d";
static const char long_spc748[]  = " Invalid thread level (%d)";
static const char short_spc749[] = "**too_big_for_input %s";
static const char long_spc749[]  = "The input argument %s is too big to fit for internal routines";
static const char short_spc750[] = "**toomanycomm %d %d %d";
static const char long_spc750[]  = "Too many communicators (%d/%d free on this process; ignore_id=%d)";
static const char short_spc751[] = "**toomanycommfrag %d %d %d";
static const char long_spc751[]  = " Cannot allocate context ID because of fragmentation (%d/%d free on this process; ignore_id=%d)";
static const char short_spc752[] = "**topotoolarge %d %d";
static const char long_spc752[]  = "Topology size %d is larger than communicator size (%d)";
static const char short_spc753[] = "**treetype %d";
static const char long_spc753[]  = " Invalid tree type (%d) used for initializing Tree algorithms";
static const char short_spc754[] = "**truncate %d %d";
static const char long_spc754[]  = "Message truncated; %d bytes received but buffer size is %d";
static const char short_spc755[] = "**truncate %d %d %d %d";
static const char long_spc755[]  = "Message from rank %d and tag %d truncated; %d bytes received but buffer size is %d";
static const char short_spc756[] = "**typeinitbadmem %d";
static const char long_spc756[]  = "%dth builtin datatype handle references invalid memory";
static const char short_spc757[] = "**typematchsize %s %d";
static const char long_spc757[]  = "No MPI datatype available for typeclass %s and size %d";
static const char short_spc758[] = "**ucx_nm_rq_error %s %d %s %s";
static const char long_spc758[]  = " returned failed request in UCX netmod(%s %d %s %s)";
static const char short_spc759[] = "**ucx_nm_status %s %d %s %s";
static const char long_spc759[]  = " ucx function returned with failed status(%s %d %s %s)";
static const char short_spc760[] = "**unknowngpid %d %d";
static const char long_spc760[]  = "Internal MPI error: Unknown gpid (%d)%d";
static const char short_spc761[] = "**usercancel %d";
static const char long_spc761[]  = "user request cancel function returned error code %d";
static const char short_spc762[] = "**usercopy %d";
static const char long_spc762[]  = "user copy function returned error code %d";
static const char short_spc763[] = "**userdel %d";
static const char long_spc763[]  = "user delete function returned error code %d";
static const char short_spc764[] = "**userfree %d";
static const char long_spc764[]  = "user request free function returned error code %d";
static const char short_spc765[] = "**userquery %d";
static const char long_spc765[]  = "user request query function returned error code %d";
static const char short_spc766[] = "**windows_mutex %s";
static const char long_spc766[]  = "Windows mutex routine failed (%s)";
static const char short_spc767[] = "**winflavor %s";
static const char long_spc767[]  = " Window flavor is not compatible with the given operation (expected %s)";
static const char short_spc768[] = "**write %s";
static const char long_spc768[]  = "write to socket failed - %s";
static const char short_spc769[] = "**writev %s";
static const char long_spc769[]  = "writev to socket failed - %s";

static const int specific_msgs_len = 770;
...
207,204,222,743,2,765,172,171,880,174,
175,932,987,121,173,1018,23,258,254,916,
