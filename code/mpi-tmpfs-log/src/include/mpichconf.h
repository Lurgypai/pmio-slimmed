...
/* Define to 1 if you have the `netloc' library (-lnetloc). */
/* #undef HAVE_LIBNETLOC */
...
#define MPIDI_CH4_VCI_METHOD MPICH_VCI__ZERO
...
#define PACKAGE_STRING "MPICH 4.0a2"
...
#define SIZEOF_MPII_BSEND_DATA_T 88
