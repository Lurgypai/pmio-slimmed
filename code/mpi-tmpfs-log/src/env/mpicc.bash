...
if test "yes" = "no" -o "${interlib_deps}" = "no" ; then
    ...
    final_libs="${final_libs}   -lpthread  S["HWLOC_EMBEDDED_LIBS"]="-lm  -ludev -lpciaccess" -L/global/homes/k/keeganih/mpich_tmpfs_log_ins/lib  -lrt -lrdmacm -libverbs -lefa -latomic -lpthread -ldl -lrt "
fi
