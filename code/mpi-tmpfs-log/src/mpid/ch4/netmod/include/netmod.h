...
typedef int (*MPIDI_NM_mpi_psend_init_t) (void *buf, int partitions, MPI_Aint count,
...
int MPIDI_NM_mpi_psend_init(void *buf, int partitions, MPI_Aint count, MPI_Datatype datatype,
